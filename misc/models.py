...
class Misc(models.Model):
    ...
    created_at = models.BigIntegerField(default=time.time, verbose_name=u"创建时间", blank=True)
    updated_at = models.BigIntegerField(default=time.time, verbose_name=u"更新时间", blank=True)
