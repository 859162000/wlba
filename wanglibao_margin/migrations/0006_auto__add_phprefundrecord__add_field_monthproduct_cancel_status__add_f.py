...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhpRefundRecord'
        db.create_table(u'wanglibao_margin_phprefundrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('refund_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL)),
            ('catalog', self.gf('django.db.models.fields.CharField')(default='0', max_length=32, db_index=True)),
        ...
        db.send_create_signal(u'wanglibao_margin', ['PhpRefundRecord'])

        # Adding field 'MonthProduct.cancel_status'
        db.add_column(u'wanglibao_margin_monthproduct', 'cancel_status',
    ...
    def backwards(self, orm):
        # Deleting model 'PhpRefundRecord'
        db.delete_table(u'wanglibao_margin_phprefundrecord')

        # Deleting field 'MonthProduct.cancel_status'
        db.delete_column(u'wanglibao_margin_monthproduct', 'cancel_status')
    ...
    models = {
        ...
        u'wanglibao_margin.monthproduct': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pay_status': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'product_id': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
