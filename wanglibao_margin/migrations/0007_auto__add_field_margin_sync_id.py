...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Margin.sync_id'
        db.add_column(u'wanglibao_margin_margin', 'sync_id',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Margin.sync_id'
        db.delete_column(u'wanglibao_margin_margin', 'sync_id')
