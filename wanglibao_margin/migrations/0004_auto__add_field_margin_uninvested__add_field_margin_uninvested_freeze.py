...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Margin.uninvested'
        db.add_column(u'wanglibao_margin_margin', 'uninvested',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Margin.uninvested_freeze'
        db.add_column(u'wanglibao_margin_margin', 'uninvested_freeze',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Margin.uninvested'
        db.delete_column(u'wanglibao_margin_margin', 'uninvested')

        # Deleting field 'Margin.uninvested_freeze'
        db.delete_column(u'wanglibao_margin_margin', 'uninvested_freeze')
