...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Margin.exchanging'
        db.add_column(u'wanglibao_margin_margin', 'exchanging',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Margin.exchanging'
        db.delete_column(u'wanglibao_margin_margin', 'exchanging')
    ...
    models = {
        ...
        u'wanglibao_margin.margin': {
            ...
            'exchanging': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
