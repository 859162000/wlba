...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MarginRecord', fields ['user_id']
        db.create_index(u'wanglibao_margin_marginrecord', ['user_id'])

        # Adding index on 'MarginRecord', fields ['order_id']
        db.create_index(u'wanglibao_margin_marginrecord', ['order_id'])


    def backwards(self, orm):
        # Removing index on 'MarginRecord', fields ['order_id']
        db.delete_index(u'wanglibao_margin_marginrecord', ['order_id'])

        # Removing index on 'MarginRecord', fields ['user_id']
        db.delete_index(u'wanglibao_margin_marginrecord', ['user_id'])
