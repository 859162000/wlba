...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Margin.other_amount'
        db.add_column(u'wanglibao_margin_margin', 'other_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Margin.other_amount'
        db.delete_column(u'wanglibao_margin_margin', 'other_amount')
