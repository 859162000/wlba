...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ExperienceAmortization', fields ['term_date']
        db.create_index(u'experience_gold_experienceamortization', ['term_date'])

        # Adding index on 'ExperienceAmortization', fields ['settled']
        db.create_index(u'experience_gold_experienceamortization', ['settled'])


    def backwards(self, orm):
        # Removing index on 'ExperienceAmortization', fields ['settled']
        db.delete_index(u'experience_gold_experienceamortization', ['settled'])

        # Removing index on 'ExperienceAmortization', fields ['term_date']
        db.delete_index(u'experience_gold_experienceamortization', ['term_date'])
    ...
    models = {
        ...
        u'experience_gold.experienceamortization': {
            ...
            'settled': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'settlement_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'term': ('django.db.models.fields.IntegerField', [], {}),
            'term_date': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
