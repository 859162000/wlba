...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExperiencePurchaseLockRecord'
        db.create_table(u'experience_gold_experiencepurchaselockrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('purchase_code', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('purchase_times', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'experience_gold', ['ExperiencePurchaseLockRecord'])

        # Adding unique constraint on 'ExperiencePurchaseLockRecord', fields ['user', 'purchase_code']
        db.create_unique(u'experience_gold_experiencepurchaselockrecord', ['user_id', 'purchase_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'ExperiencePurchaseLockRecord', fields ['user', 'purchase_code']
        db.delete_unique(u'experience_gold_experiencepurchaselockrecord', ['user_id', 'purchase_code'])

        # Deleting model 'ExperiencePurchaseLockRecord'
        db.delete_table(u'experience_gold_experiencepurchaselockrecord')
    ...
    models = {
        ...
        u'experience_gold.experiencepurchaselockrecord': {
            'Meta': {'unique_together': "(('user', 'purchase_code'),)", 'object_name': 'ExperiencePurchaseLockRecord'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'purchase_code': ('django.db.models.fields.CharField', [], {'max_length': '64', 'db_index': 'True'}),
            'purchase_times': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
