...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InviteRelation'
        db.create_table(u'wanglibao_invite_inviterelation', (
        ...
        # Adding model 'WechatUserDailyReward'
        db.create_table(u'wanglibao_invite_wechatuserdailyreward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('w_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.WeixinUser'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('create_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_index=True, blank=True)),
            ('reward_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('redpack_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('experience_gold_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('redpack_record_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('experience_gold_record_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'wanglibao_invite', ['WechatUserDailyReward'])

        # Adding unique constraint on 'WechatUserDailyReward', fields ['w_user', 'create_date']
        db.create_unique(u'wanglibao_invite_wechatuserdailyreward', ['w_user_id', 'create_date'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UserExtraInfo'
        db.delete_table(u'wanglibao_invite_userextrainfo')

        # Deleting model 'WechatUserDailyReward'
        db.delete_table(u'wanglibao_invite_wechatuserdailyreward')
