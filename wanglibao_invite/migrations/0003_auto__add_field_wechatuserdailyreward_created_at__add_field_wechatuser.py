...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WechatUserDailyReward.created_at'
        db.add_column(u'wanglibao_invite_wechatuserdailyreward', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'WechatUserDailyReward.update_at'
        db.add_column(u'wanglibao_invite_wechatuserdailyreward', 'update_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WechatUserDailyReward.created_at'
        db.delete_column(u'wanglibao_invite_wechatuserdailyreward', 'created_at')

        # Deleting field 'WechatUserDailyReward.update_at'
        db.delete_column(u'wanglibao_invite_wechatuserdailyreward', 'update_at')
    ...
    models = {
        ...
        u'wanglibao_invite.wechatuserdailyreward': {
            ...
            'update_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
