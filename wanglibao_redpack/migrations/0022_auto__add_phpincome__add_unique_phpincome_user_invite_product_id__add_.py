...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PhpIncome', fields ['user', 'invite', 'product_id']
        db.create_unique(u'wanglibao_redpack_phpincome', ['user_id', 'invite_id', 'product_id'])

        # Adding unique constraint on 'Income', fields ['user', 'invite', 'product']
        db.create_unique(u'wanglibao_redpack_income', ['user_id', 'invite_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Income', fields ['user', 'invite', 'product']
        db.delete_unique(u'wanglibao_redpack_income', ['user_id', 'invite_id', 'product_id'])

        # Removing unique constraint on 'PhpIncome', fields ['user', 'invite', 'product_id']
        db.delete_unique(u'wanglibao_redpack_phpincome', ['user_id', 'invite_id', 'product_id'])
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 2, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 22, 0, 0)', 'db_index': 'True'}),
        ...
        u'wanglibao_redpack.income': {
            'Meta': {'unique_together': "(('user', 'invite', 'product'),)", 'object_name': 'Income'},
        ...
        u'wanglibao_redpack.phpincome': {
            'Meta': {'unique_together': "(('user', 'invite', 'product_id'),)", 'object_name': 'PhpIncome'},
            'amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'earning': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'php_invite'", 'to': u"orm['auth.User']"}),
            'level': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'order_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'product_id': ('django.db.models.fields.IntegerField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'php_user'", 'to': u"orm['auth.User']"})
        },
        ...
        u'wanglibao_redpack.redpackrecord': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_month_product': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
