...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RedPackEvent.amount'
        db.alter_column(u'wanglibao_redpack_redpackevent', 'amount', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'RedPackEvent.amount'
        db.alter_column(u'wanglibao_redpack_redpackevent', 'amount', self.gf('django.db.models.fields.IntegerField')())
