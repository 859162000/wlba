...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackEvent.p2p_types'
        db.add_column(u'wanglibao_redpack_redpackevent', 'p2p_types',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.ProductType'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'RedPackEvent.pay_method'
        db.add_column(u'wanglibao_redpack_redpackevent', 'pay_method',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RedPackEvent.period'
        db.add_column(u'wanglibao_redpack_redpackevent', 'period',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackEvent.p2p_types'
        db.delete_column(u'wanglibao_redpack_redpackevent', 'p2p_types_id')

        # Deleting field 'RedPackEvent.pay_method'
        db.delete_column(u'wanglibao_redpack_redpackevent', 'pay_method')

        # Deleting field 'RedPackEvent.period'
        db.delete_column(u'wanglibao_redpack_redpackevent', 'period')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 16, 0, 0)'}),
        ...
        u'wanglibao_redpack.redpackevent': {
            ...
            'pay_method': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
