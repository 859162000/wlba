...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackRecord.product_id'
        db.add_column(u'wanglibao_redpack_redpackrecord', 'product_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackRecord.product_id'
        db.delete_column(u'wanglibao_redpack_redpackrecord', 'product_id')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 31, 0, 0)'}),
