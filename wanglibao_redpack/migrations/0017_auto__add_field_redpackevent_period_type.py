...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackEvent.period_type'
        db.add_column(u'wanglibao_redpack_redpackevent', 'period_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u6708', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackEvent.period_type'
        db.delete_column(u'wanglibao_redpack_redpackevent', 'period_type')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 10, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 30, 0, 0)'}),
