...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackRecord.apply_amount'
        db.add_column(u'wanglibao_redpack_redpackrecord', 'apply_amount',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackRecord.apply_amount'
        db.delete_column(u'wanglibao_redpack_redpackrecord', 'apply_amount')
