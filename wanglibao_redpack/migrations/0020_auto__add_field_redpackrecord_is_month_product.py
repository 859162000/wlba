...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackRecord.is_month_product'
        db.add_column(u'wanglibao_redpack_redpackrecord', 'is_month_product',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackRecord.is_month_product'
        db.delete_column(u'wanglibao_redpack_redpackrecord', 'is_month_product')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 9, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 28, 0, 0)', 'db_index': 'True'}),
