...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Income'
        db.create_table(u'wanglibao_redpack_income', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user', to=orm['auth.User'])),
            ('invite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invite', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'wanglibao_redpack', ['Income'])


    def backwards(self, orm):
        # Deleting model 'Income'
        db.delete_table(u'wanglibao_redpack_income')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 30, 0, 0)'}),
