...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RedPackEvent.period'
        db.alter_column(u'wanglibao_redpack_redpackevent', 'period', self.gf('django.db.models.fields.IntegerField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'RedPackEvent.period'
        db.alter_column(u'wanglibao_redpack_redpackevent', 'period', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 13, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 3, 0, 0)'}),
