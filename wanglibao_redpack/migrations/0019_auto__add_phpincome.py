...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhpIncome'
        db.create_table(u'wanglibao_redpack_phpincome', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='php_user', to=orm['auth.User'])),
            ('invite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='php_invite', to=orm['auth.User'])),
            ...
            ('earning', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2)),
            ('order_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'wanglibao_redpack', ['PhpIncome'])


    def backwards(self, orm):
        # Deleting model 'PhpIncome'
        db.delete_table(u'wanglibao_redpack_phpincome')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 1, 2, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 23, 0, 0)'}),
