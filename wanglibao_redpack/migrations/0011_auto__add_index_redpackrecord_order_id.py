...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'RedPackRecord', fields ['order_id']
        db.create_index(u'wanglibao_redpack_redpackrecord', ['order_id'])


    def backwards(self, orm):
        # Removing index on 'RedPackRecord', fields ['order_id']
        db.delete_index(u'wanglibao_redpack_redpackrecord', ['order_id'])
