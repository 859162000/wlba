...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterestHike'
        db.create_table(u'wanglibao_redpack_interesthike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.P2PProduct'])),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=5)),
            ('intro_total', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'wanglibao_redpack', ['InterestHike'])


    def backwards(self, orm):
        # Deleting model 'InterestHike'
        db.delete_table(u'wanglibao_redpack_interesthike')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 10, 0, 0)'}),
