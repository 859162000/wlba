...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackEvent.highest_amount'
        db.add_column(u'wanglibao_redpack_redpackevent', 'highest_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackEvent.highest_amount'
        db.delete_column(u'wanglibao_redpack_redpackevent', 'highest_amount')
