...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InterestHike.expired_at'
        db.delete_column(u'wanglibao_redpack_interesthike', 'expired_at')


    def backwards(self, orm):
        # Adding field 'InterestHike.expired_at'
        db.add_column(u'wanglibao_redpack_interesthike', 'expired_at',
