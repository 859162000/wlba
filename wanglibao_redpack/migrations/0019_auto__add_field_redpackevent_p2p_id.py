...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RedPackEvent.p2p_id'
        db.add_column(u'wanglibao_redpack_redpackevent', 'p2p_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RedPackEvent.p2p_id'
        db.delete_column(u'wanglibao_redpack_redpackevent', 'p2p_id')
