...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CallbackRecord', fields ['order_id']
        db.delete_unique(u'common_callbackrecord', ['order_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'CallbackRecord', fields ['order_id']
        db.create_unique(u'common_callbackrecord', ['order_id'])
