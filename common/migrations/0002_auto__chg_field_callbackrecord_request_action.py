...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CallbackRecord.request_action'
        db.alter_column(u'common_callbackrecord', 'request_action', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'CallbackRecord.request_action'
        db.alter_column(u'common_callbackrecord', 'request_action', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'common.callbackrecord': {
            ...
            'request_action': ('django.db.models.fields.CharField', [], {'default': '1', 'max_length': '6'}),
