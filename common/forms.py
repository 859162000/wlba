...
from django.forms.fields import Field as FieldBase
from django.utils.encoding import force_text, smart_text, force_str
from django.utils.datastructures import SortedDict
from django.utils.ipv6 import clean_ipv6_address
from django.utils.six.moves.urllib.parse import urlsplit, urlunsplit
from django.forms.widgets import (TextInput, NumberInput, EmailInput, URLInput,
                                  MultipleHiddenInput, ClearableFileInput, CheckboxInput,
                                  Select, NullBooleanSelect, SelectMultiple, DateInput,
                                  DateTimeInput, TimeInput, SplitDateTimeWidget,
                                  SplitHiddenDateTimeWidget, FILE_INPUT_CONTRADICTION,
                                  media_property)
...
class Field(FieldBase):
    ...
    def validate(self, value):
        if value in self.empty_values and self.required:
            raise ValidationError(self.error_messages['required'], code=10099)
