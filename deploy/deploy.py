...
env.roledefs = {
    'git_server': ["182.92.4.90"],
    #'lb': ["182.92.4.90", "112.126.64.180"],
    'channel': ["123.56.232.236"],
}
env.user = "wangli"
...
env.git_server_address = "git clone wangli@10.165.69.234:~/channel/wanglibao-backend"
...
env.redis_server = "10.171.17.243"
env.mq_server = "10.171.17.243"
