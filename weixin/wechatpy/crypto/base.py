...
from weixin.wechatpy.utils import to_text, to_binary
from weixin.wechatpy._compat import byte2int
from weixin.wechatpy.crypto.pkcs7 import PKCS7Encoder
try:
    from weixin.wechatpy.crypto.cryptography import WeChatCipher
except ImportError:
    try:
        from weixin.wechatpy.crypto.pycrypto import WeChatCipher
    except ImportError:
