...
from weixin.wechatpy.utils import to_text, to_binary, WeChatSigner
from weixin.wechatpy.exceptions import (
    InvalidAppIdException,
    InvalidSignatureException
)
from weixin.wechatpy.crypto.base import BasePrpCrypto
...
class BaseWeChatCrypto(object):
    ...
    def _encrypt_message(self,
                         ...
                         timestamp=None,
                         crypto_class=None):
        from weixin.wechatpy.replies import BaseReply
