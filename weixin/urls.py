...
urlpatterns = patterns(
    ...
    url(r'^sub_list/$', fwh_login_required(main_views.FwhP2PlistTemplate.as_view(template_name="service_list.jade"), login_url="/weixin/sub_login_redirect/")),
...
urlpatterns += patterns(
    '',
    url(r'activity/si_bind_login/$', activity_views.WechatShareInviteBindTemplate.as_view(template_name=".jade")),
    url(r'^activity/invite/$', fwh_login_required(activity_views.WechatInviteTemplate.as_view(template_name="invite_redpacket_get.jade"),login_url='/weixin/activity/si_bind_login/'),name='fwh_invite'),
