...
if settings.ENV == settings.ENV_PRODUCTION:
    ...
    BIND_SUCCESS_TEMPLATE_ID = "66MJEd_iO7MlvcT1FP6aDkkSAUfA-zrA12LX0D7to1s"
    UNBIND_SUCCESS_TEMPLATE_ID = "ajnYKZIGUL8YAWJyzxzZJIGhFTkHar1sXwbYUs0Eue4"
    ACCOUNT_INFO_TEMPLATE_ID = "9KCvqqUYmuYQpuFWHD6j_BSqthAbZ0BJzTP1I6DBO_0"
    PRODUCT_ONLINE_TEMPLATE_ID = "H8keZIMZ8MkPoKl3Jo4tIEW9qhOJyB09NioXOi9Qk7E"
