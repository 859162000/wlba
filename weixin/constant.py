...
if settings.ENV == settings.ENV_PRODUCTION:
    ...
    AWARD_COUPON_TEMPLATE_ID  = "_-Xlr2icPtM5sXj0VKuF3fleKYR-Rl4a_h2gpcd_95M"
    WITH_DRAW_SUBMITTED_TEMPLATE_ID = "pr2ECl9m81b57IwhW2O4_PmW5GeMMWpGyUg-DymwsYg"#"Paf_qr_WiojI3BddoDvqNKMI1C7KRzayEA_XGrmgQac"#取现已受理通知
    WITH_DRAW_SUCCESS_TEMPLATE_ID = ""
    DEPOSIT_SUCCESS_TEMPLATE_ID = "_T5Akr3kBKo4gr5joQQseKqCjmAbbkawEBeHS9P4AuU"#"LuwpMH6CdEP2IeEsB7h6uewLhZdrnQPb0vmjDlqWh70"     #充值到账通知
    PRODUCT_AMORTIZATION_TEMPLATE_ID = "h9Fxr0BbHP20wfYJ5D44YUWHaSuURmDeqngeY7NIu8o"#"wDHmjettSpgHys4HMXdcndUfkloiQNu2j9LXTa_qkO4"#项目还款通知
    PRODUCT_INVEST_SUCCESS_TEMPLATE_ID = "wbV38-H2u0LkOZRGjB3fWMpj4CczgMdAP7aiTg4SM8A"#"JgSYj3TqABs9UbmA33QfkZ2ZGjHL436oBBvOMpyWGh8"#投标成功通知
