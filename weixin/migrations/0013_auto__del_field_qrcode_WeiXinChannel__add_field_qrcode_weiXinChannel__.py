...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QrCode.WeiXinChannel'
        db.delete_column(u'weixin_qrcode', 'WeiXinChannel_id')

        # Adding field 'QrCode.weiXinChannel'
        db.add_column(u'weixin_qrcode', 'weiXinChannel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.WeiXinChannel'], null=True),
                      keep_default=False)

        # Adding field 'SubscribeRecord.subscribe_time'
        db.add_column(u'weixin_subscriberecord', 'subscribe_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SubscribeRecord.unsubscribe_time'
        db.add_column(u'weixin_subscriberecord', 'unsubscribe_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeixinUser.unsubscribe_time'
        db.add_column(u'weixin_weixinuser', 'unsubscribe_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeixinUser.bind_time'
        db.add_column(u'weixin_weixinuser', 'bind_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeixinUser.unbind_time'
        db.add_column(u'weixin_weixinuser', 'unbind_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubscribeRecord.subscribe_time'
        db.delete_column(u'weixin_subscriberecord', 'subscribe_time')

        # Deleting field 'SubscribeRecord.unsubscribe_time'
        db.delete_column(u'weixin_subscriberecord', 'unsubscribe_time')

        # Deleting field 'WeixinUser.unsubscribe_time'
        db.delete_column(u'weixin_weixinuser', 'unsubscribe_time')

        # Deleting field 'WeixinUser.bind_time'
        db.delete_column(u'weixin_weixinuser', 'bind_time')

        # Deleting field 'WeixinUser.unbind_time'
        db.delete_column(u'weixin_weixinuser', 'unbind_time')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'YUQPf4VA'", 'max_length': '32'})
        },
