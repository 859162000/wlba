...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WeiXinUserActionRecord.user'
        db.delete_column(u'weixin_weixinuseractionrecord', 'user_id')

        # Deleting field 'WeiXinUserActionRecord.w_user'
        db.delete_column(u'weixin_weixinuseractionrecord', 'w_user_id')

        # Adding field 'WeiXinUserActionRecord.w_user_id'
        db.add_column(u'weixin_weixinuseractionrecord', 'w_user_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WeiXinUserActionRecord.user_id'
        db.add_column(u'weixin_weixinuseractionrecord', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WeiXinUserActionRecord.user'
        db.add_column(u'weixin_weixinuseractionrecord', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'WeiXinUserActionRecord.w_user'
        db.add_column(u'weixin_weixinuseractionrecord', 'w_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.WeixinUser'], null=True),
                      keep_default=False)

        # Deleting field 'WeiXinUserActionRecord.w_user_id'
        db.delete_column(u'weixin_weixinuseractionrecord', 'w_user_id')

        # Deleting field 'WeiXinUserActionRecord.user_id'
        db.delete_column(u'weixin_weixinuseractionrecord', 'user_id')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'WOGHFBzC'", 'max_length': '32'})
        },
