...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeiXinChannel'
        db.create_table(u'weixin_weixinchannel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12, db_index=True)),
            ('digital_code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True)),
            ('is_abandoned', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'weixin', ['WeiXinChannel'])

        # Deleting field 'QrCode.scene_str'
        db.delete_column(u'weixin_qrcode', 'scene_str')
    ...
    def backwards(self, orm):
        # Deleting model 'WeiXinChannel'
        db.delete_table(u'weixin_weixinchannel')

        # Adding field 'QrCode.scene_str'
        db.add_column(u'weixin_qrcode', 'scene_str',
                      self.gf('django.db.models.fields.CharField')(default='aa', max_length=128),
                      keep_default=False)
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'lfgyrUpM'", 'max_length': '32'})
        },
