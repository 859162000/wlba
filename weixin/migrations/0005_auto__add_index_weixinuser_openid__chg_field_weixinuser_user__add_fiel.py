...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WeixinUser', fields ['openid']
        db.create_index(u'weixin_weixinuser', ['openid'])


        # Changing field 'WeixinUser.user'
        db.alter_column(u'weixin_weixinuser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        # Adding field 'Account.oauth_access_token_content'
        db.add_column(u'weixin_account', 'oauth_access_token_content',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Account.oauth_access_token_expires_at'
        db.add_column(u'weixin_account', 'oauth_access_token_expires_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Account.oauth_refresh_token'
        db.add_column(u'weixin_account', 'oauth_refresh_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing index on 'WeixinUser', fields ['openid']
        db.delete_index(u'weixin_weixinuser', ['openid'])


        # Changing field 'WeixinUser.user'
        db.alter_column(u'weixin_weixinuser', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2015, 5, 11, 0, 0), to=orm['auth.User']))
        # Deleting field 'Account.oauth_access_token_content'
        db.delete_column(u'weixin_account', 'oauth_access_token_content')

        # Deleting field 'Account.oauth_access_token_expires_at'
        db.delete_column(u'weixin_account', 'oauth_access_token_expires_at')

        # Deleting field 'Account.oauth_refresh_token'
        db.delete_column(u'weixin_account', 'oauth_refresh_token')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'yAEOnbIG'", 'max_length': '32'})
        },
        u'weixin.material': {
