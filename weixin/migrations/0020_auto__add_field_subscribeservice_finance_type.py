...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubscribeService.finance_type'
        db.add_column(u'weixin_subscribeservice', 'finance_type',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubscribeService.finance_type'
        db.delete_column(u'weixin_subscribeservice', 'finance_type')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'Kfoz0lsL'", 'max_length': '32'})
        },
