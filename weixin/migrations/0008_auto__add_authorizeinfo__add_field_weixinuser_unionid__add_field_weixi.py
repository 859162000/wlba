...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AuthorizeInfo'
        db.create_table(u'weixin_authorizeinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('access_token_expires_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('refresh_token', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
        ))
        db.send_create_signal(u'weixin', ['AuthorizeInfo'])

        # Adding field 'WeixinUser.unionid'
        db.add_column(u'weixin_weixinuser', 'unionid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'WeixinUser.auth_info'
        db.add_column(u'weixin_weixinuser', 'auth_info',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.AuthorizeInfo'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AuthorizeInfo'
        db.delete_table(u'weixin_authorizeinfo')

        # Deleting field 'WeixinUser.unionid'
        db.delete_column(u'weixin_weixinuser', 'unionid')

        # Deleting field 'WeixinUser.auth_info'
        db.delete_column(u'weixin_weixinuser', 'auth_info_id')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'IMaVl8gy'", 'max_length': '32'})
        },
