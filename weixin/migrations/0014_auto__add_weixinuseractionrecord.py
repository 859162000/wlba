...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeiXinUserActionRecord'
        db.create_table(u'weixin_weixinuseractionrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('w_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.WeixinUser'], null=True)),
        ...
        db.send_create_signal(u'weixin', ['WeiXinUserActionRecord'])


    def backwards(self, orm):
        # Deleting model 'WeiXinUserActionRecord'
        db.delete_table(u'weixin_weixinuseractionrecord')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'ywbChvqO'", 'max_length': '32'})
        },
