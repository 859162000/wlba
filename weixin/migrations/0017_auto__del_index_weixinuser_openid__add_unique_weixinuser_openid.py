...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'WeixinUser', fields ['openid']
        db.create_unique(u'weixin_weixinuser', ['openid'])


    def backwards(self, orm):
        # Removing unique constraint on 'WeixinUser', fields ['openid']
        db.delete_unique(u'weixin_weixinuser', ['openid'])
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'lGdBLorn'", 'max_length': '32'})
        },
