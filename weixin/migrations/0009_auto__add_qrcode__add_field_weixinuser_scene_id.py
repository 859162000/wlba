...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QrCode'
        db.create_table(u'weixin_qrcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_original_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=32, blank=True)),
            ('ticket', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('expire_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('qrcode_url', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('scene_str', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('create_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'weixin', ['QrCode'])

        # Adding field 'WeixinUser.scene_id'
        db.add_column(u'weixin_weixinuser', 'scene_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'weixin_qrcode')

        # Deleting field 'WeixinUser.scene_id'
        db.delete_column(u'weixin_weixinuser', 'scene_id')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'SyAHtpN9'", 'max_length': '32'})
        },
