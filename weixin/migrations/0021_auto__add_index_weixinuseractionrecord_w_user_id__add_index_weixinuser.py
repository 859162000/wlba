...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WeiXinUserActionRecord', fields ['w_user_id']
        db.create_index(u'weixin_weixinuseractionrecord', ['w_user_id'])

        # Adding index on 'WeiXinUserActionRecord', fields ['user_id']
        db.create_index(u'weixin_weixinuseractionrecord', ['user_id'])


    def backwards(self, orm):
        # Removing index on 'WeiXinUserActionRecord', fields ['user_id']
        db.delete_index(u'weixin_weixinuseractionrecord', ['user_id'])

        # Removing index on 'WeiXinUserActionRecord', fields ['w_user_id']
        db.delete_index(u'weixin_weixinuseractionrecord', ['w_user_id'])
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'LGAhmqzC'", 'max_length': '32'})
        },
        ...
        u'weixin.subscribeservice': {
            ...
            'finance_type': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'weixin.weixinuseractionrecord': {
            ...
            'w_user_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'})
        }
    }
