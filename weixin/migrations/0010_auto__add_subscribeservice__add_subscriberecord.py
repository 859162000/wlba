...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubscribeService'
        db.create_table(u'weixin_subscribeservice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, db_index=True)),
            ('describe', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('num_limit', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'weixin', ['SubscribeService'])

        # Adding model 'SubscribeRecord'
        db.create_table(u'weixin_subscriberecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.SubscribeService'])),
        ))
        db.send_create_signal(u'weixin', ['SubscribeRecord'])


    def backwards(self, orm):
        # Deleting model 'SubscribeService'
        db.delete_table(u'weixin_subscribeservice')

        # Deleting model 'SubscribeRecord'
        db.delete_table(u'weixin_subscriberecord')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'DjvrtFNo'", 'max_length': '32'})
        },
        ...
        u'weixin.subscribeservice': {
            'Meta': {'object_name': 'SubscribeService'},
