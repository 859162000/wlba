...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeriesActionActivityRule'
        db.create_table(u'weixin_seriesactionactivityrule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['weixin.SeriesActionActivity'])),
            ...
            ('redpack', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('reward', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ...
            ('wx_template', self.gf('django.db.models.fields.CharField')(default=u'', max_length=32, blank=True)),
            ('msg_template_introduce', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('sms_template_introduce', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('is_used', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'weixin', ['SeriesActionActivityRule'])

        # Adding model 'SeriesActionActivity'
        db.create_table(u'weixin_seriesactionactivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'weixin', ['SeriesActionActivity'])

        # Adding unique constraint on 'SeriesActionActivity', fields ['action_type', 'days']
        db.create_unique(u'weixin_seriesactionactivity', ['action_type', 'days'])

        # Adding model 'UserDailyActionRecord'
        db.create_table(u'weixin_userdailyactionrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL)),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('action_describe', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('extra_data', self.gf('wanglibao.fields.JSONFieldUtf8')(blank=True)),
            ('create_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, db_index=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('continue_days', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('experience_record_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'weixin', ['UserDailyActionRecord'])

        # Adding unique constraint on 'UserDailyActionRecord', fields ['user', 'action_type', 'create_date']
        db.create_unique(u'weixin_userdailyactionrecord', ['user_id', 'action_type', 'create_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserDailyActionRecord', fields ['user', 'action_type', 'create_date']
        db.delete_unique(u'weixin_userdailyactionrecord', ['user_id', 'action_type', 'create_date'])

        # Removing unique constraint on 'SeriesActionActivity', fields ['action_type', 'days']
        db.delete_unique(u'weixin_seriesactionactivity', ['action_type', 'days'])

        # Deleting model 'SeriesActionActivityRule'
        db.delete_table(u'weixin_seriesactionactivityrule')

        # Deleting model 'SeriesActionActivity'
        db.delete_table(u'weixin_seriesactionactivity')

        # Deleting model 'UserDailyActionRecord'
        db.delete_table(u'weixin_userdailyactionrecord')
    ...
    models = {
        ...
        u'weixin.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "u'7jKrMgyI'", 'max_length': '32'})
        },
        ...
        u'weixin.seriesactionactivity': {
            'Meta': {'unique_together': "((u'action_type', u'days'),)", 'object_name': 'SeriesActionActivity'},
        ...
        u'weixin.seriesactionactivityrule': {
            'Meta': {'object_name': 'SeriesActionActivityRule'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['weixin.SeriesActionActivity']"}),
            ...
            'wx_template': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32', 'blank': 'True'})
        },
        ...
        u'weixin.userdailyactionrecord': {
            'Meta': {'unique_together': "((u'user', u'action_type', u'create_date'),)", 'object_name': 'UserDailyActionRecord'},
        ...
        u'weixin.weixinuseractionrecord': {
            ...
            'w_user_id': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
