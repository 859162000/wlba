...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeriesActionActivityRule.addition_gift_type'
        db.add_column(u'weixin_seriesactionactivityrule', 'addition_gift_type',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=20),
                      keep_default=False)

        # Adding field 'SeriesActionActivityRule.addition_redpack'
        db.add_column(u'weixin_seriesactionactivityrule', 'addition_redpack',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'UserDailyActionRecord.platform'
        db.add_column(u'weixin_userdailyactionrecord', 'platform',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'weixin_seriesactionactivityrule', 'addition_gift_type')

        # Deleting field 'SeriesActionActivityRule.addition_redpack'
        db.delete_column(u'weixin_seriesactionactivityrule', 'addition_redpack')
    ...
    models = {
        ...
        u'weixin.seriesactionactivity': {
            'Meta': {'ordering': "(u'days',)", 'unique_together': "((u'action_type', u'days'),)", 'object_name': 'SeriesActionActivity'},
        ...
        u'weixin.seriesactionactivityrule': {
            ...
            'addition_gift_type': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '20'}),
            'addition_redpack': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200', 'blank': 'True'}),
        ...
        u'weixin.userdailyactionrecord': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'platform': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '32'}),
            'status': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
