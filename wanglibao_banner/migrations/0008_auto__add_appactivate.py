...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppActivate'
        db.create_table(u'wanglibao_banner_appactivate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('device', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('img_one', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('img_two', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('img_three', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_long_used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ...
        db.send_create_signal(u'wanglibao_banner', ['AppActivate'])


    def backwards(self, orm):
        # Deleting model 'AppActivate'
        db.delete_table(u'wanglibao_banner_appactivate')
