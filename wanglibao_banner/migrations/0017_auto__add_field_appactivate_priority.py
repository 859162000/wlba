...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppActivate.priority'
        db.add_column(u'wanglibao_banner_appactivate', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppActivate.priority'
        db.delete_column(u'wanglibao_banner_appactivate', 'priority')
