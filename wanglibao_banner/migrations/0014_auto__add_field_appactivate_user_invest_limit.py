...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppActivate.user_invest_limit'
        db.add_column(u'wanglibao_banner_appactivate', 'user_invest_limit',
                      self.gf('django.db.models.fields.CharField')(default=u'-1', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppActivate.user_invest_limit'
        db.delete_column(u'wanglibao_banner_appactivate', 'user_invest_limit')
