...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppActivate.pc_redirect_url'
        db.add_column(u'wanglibao_banner_appactivate', 'pc_redirect_url',
                      self.gf('django.db.models.fields.CharField')(default=u'http://', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppActivate.pc_redirect_url'
        db.delete_column(u'wanglibao_banner_appactivate', 'pc_redirect_url')
