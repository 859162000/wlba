...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppActivate.link_dest_h5_url'
        db.add_column(u'wanglibao_banner_appactivate', 'link_dest_h5_url',
                      self.gf('django.db.models.fields.CharField')(default=u'https://', max_length=300),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AppActivate.link_dest_h5_url'
        db.delete_column(u'wanglibao_banner_appactivate', 'link_dest_h5_url')
    ...
    models = {
        ...
        u'wanglibao_banner.appactivate': {
            ...
            'user_login_status_limit': ('django.db.models.fields.CharField', [], {'default': "u'-1'", 'max_length': '8'})
        },
