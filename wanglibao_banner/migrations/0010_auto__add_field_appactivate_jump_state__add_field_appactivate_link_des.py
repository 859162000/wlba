...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppActivate.jump_state'
        db.add_column(u'wanglibao_banner_appactivate', 'jump_state',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AppActivate.link_dest'
        db.add_column(u'wanglibao_banner_appactivate', 'link_dest',
                      self.gf('django.db.models.fields.CharField')(default=u'3', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppActivate.jump_state'
        db.delete_column(u'wanglibao_banner_appactivate', 'jump_state')

        # Deleting field 'AppActivate.link_dest'
        db.delete_column(u'wanglibao_banner_appactivate', 'link_dest')
