...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobileMainPage'
        db.create_table(u'wanglibao_hotlist_mobilemainpage', (
            ...
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wanglibao_fund.Fund'], unique=True)),
        ))
        db.send_create_signal(u'wanglibao_hotlist', ['MobileMainPage'])


    def backwards(self, orm):
        # Deleting model 'MobileMainPage'
        db.delete_table(u'wanglibao_hotlist_mobilemainpage')
    ...
    models = {
        ...
        u'trust.trust': {
            ...
            'financing_party': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
