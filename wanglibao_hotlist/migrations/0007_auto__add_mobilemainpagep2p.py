...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobileMainPageP2P'
        db.create_table(u'wanglibao_hotlist_mobilemainpagep2p', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hot_score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True)),
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wanglibao_p2p.P2PProduct'], unique=True)),
        ))
        db.send_create_signal(u'wanglibao_hotlist', ['MobileMainPageP2P'])


    def backwards(self, orm):
        # Deleting model 'MobileMainPageP2P'
        db.delete_table(u'wanglibao_hotlist_mobilemainpagep2p')
    ...
    models = {
        ...
        u'trust.trust': {
            ...
            'expected_earning_rate_high': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            ...
            'product_type': ('django.db.models.fields.CharField', [], {'default': "u'\\u4fe1\\u6258'", 'max_length': '20'}),
        ...
        u'wanglibao_fund.fund': {
            ...
            'rapid_redeem': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'wanglibao_hotlist.mobilehotfund': {
            'Meta': {'ordering': "['-hot_score']", 'object_name': 'MobileHotFund'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
            'fund': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wanglibao_fund.Fund']", 'unique': 'True'}),
            'hot_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        ...
        u'wanglibao_hotlist.mobilehottrust': {
            'Meta': {'ordering': "['-hot_score']", 'object_name': 'MobileHotTrust'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
            'hot_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'trust': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['trust.Trust']", 'unique': 'True'})
        },
        u'wanglibao_hotlist.mobilemainpage': {
            'Meta': {'ordering': "['-hot_score']", 'object_name': 'MobileMainPage'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
            'hot_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wanglibao_fund.Fund']", 'unique': 'True'})
        },
        u'wanglibao_hotlist.mobilemainpagep2p': {
            'Meta': {'ordering': "['-hot_score']", 'object_name': 'MobileMainPageP2P'},
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True'}),
            'hot_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['wanglibao_p2p.P2PProduct']", 'unique': 'True'})
        },
