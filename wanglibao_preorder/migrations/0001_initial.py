...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_preorder_preorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('product_type', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('user_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_preorder', ['PreOrder'])


    def backwards(self, orm):
        # Deleting model 'PreOrder'
        db.delete_table(u'wanglibao_preorder_preorder')
