...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreOrder.product_url'
        db.add_column(u'wanglibao_preorder_preorder', 'product_url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreOrder.product_url'
        db.delete_column(u'wanglibao_preorder_preorder', 'product_url')
