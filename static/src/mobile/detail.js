...
import { onMenuShareAppMessage, onMenuShareQQ, onMenuShareTimeline} from './mixins/wx_share.js'
...
(()=>{
     ...
     */
    const weixin_share = () => {
            const jsApiList = ['scanQRCode', 'onMenuShareAppMessage', 'onMenuShareTimeline', 'onMenuShareQQ',];
            ajax({
                type: 'GET',
            ...
            wx.ready(function () {
                ...
                const host = 'https://www.wanglibao.com',
