 define(['jquery', 'tools'], function ($, tool) {
    ...
    jQuery.extend(sendSMSCode, {
        ...
        sendImgCode : function(){  //弹框
            var winBox = $('#img-code-div');
            winBox.modal();
            winBox.find('#id_captcha_1').val('');
            winBox.find('.code-img-error').html('');
