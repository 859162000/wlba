...
(function() {
  define(['jquery'], function($) {
    var addToFavorite, apiurl, changePassword, createPreOrder, deepCompare, isValidType, joinFavorites, loadData, loadFavorites, loadPortfolio, normalizeType, parseQuery, typeMapping, userExists;
