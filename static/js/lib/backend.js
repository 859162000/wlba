...
(function() {
  define(['jquery'], function($) {
    var addToFavorite, apiurl, changePassword, checkEmail, checkMobile, createPreOrder, isInRange, isValidType, joinFavorites, loadData, loadFavorites, loadPortfolio, normalizeType, purchaseP2P, typeMapping, userExists, userProfile;
