...
(function() {
  define(['jquery'], function($) {
    var addToFavorite, apiurl, changePassword, createPreOrder, isInRange, isValidType, joinFavorites, loadData, loadFavorites, loadPortfolio, normalizeType, typeMapping, userExists, userProfile;
