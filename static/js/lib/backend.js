...
(function() {
  define(['jquery'], function($) {
    var addToFavorite, apiurl, changePassword, createPreOrder, isValidType, joinFavorites, loadData, loadFavorites, loadPortfolio, normalizeType, typeMapping, userExists;
