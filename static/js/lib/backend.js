...
(function() {
  define(['jquery'], function($) {
    var addToFavorite, apiurl, changePassword, createPreOrder, isValidType, loadData, loadFavorites, loadPortfolio, normalizeType, typeMapping;
    ...
    addToFavorite = function(type, id) {
      var url;
