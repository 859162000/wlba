...
(function() {
  define(['jquery'], function($) {
    ...
    $('input[data-role=p2p-calculator]').keyup(function(e) {
      var activity_rate, amount, earning, earning_element, earning_elements, existing, fee_earning, fee_element, fee_elements, fee_total_earning, i, j, k, len, len1, pay_method, period, rate, results, target, total_amount, total_earning;
      target = $(e.target);
      ...
      for (i = k = 0, len1 = fee_elements.length; k < len1; i = ++k) {
        ...
        if (fee_earning && $.isNumeric(fee_earning)) {
          results.push($(fee_element).text(fee_earning));
        } else {
