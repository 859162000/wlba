  ...
  require(['jquery', 'lib/modal', 'lib/backend', 'jquery.validate', "tools", 'jquery.complexify', 'jquery.placeholder',
    ...
    $('#register-modal-form').validate({
      ...
      errorPlacement: function(error, element) {
        return error.appendTo($(element).parents('.act-form-row').children('.act-form-row-error'));
      },
    ...
    $("#button-get-validate-code-modal").click(function(e) {
      ...
      if (checkMobile(phoneNumber)) {
        ...
        $.ajax({
          ...
          $(element).removeClass('act-huoqu-ma-gray');
          result = JSON.parse(xhr.responseText);
          if (xhr.status === 429) {
        ...
        $(element).addClass('act-huoqu-ma-gray');
    ...
    function myeven() {
      ...
      $('#button-get-validate-code-modal').on('click', function () {
        ...
        setTimeout(function () {
          ...
          $('.act-show').removeClass('act-hidden');
        }, 60000)
      });
    }
