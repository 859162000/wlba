...
;(function(){
    window.alert = function(txt, callback){
        if(document.getElementById("alert-cont")){
            ...
            alertFram.style.cssText="position:fixed; bottom:1rem;left:50%; width:14rem; margin:-2.75rem 0 0 -7rem; background:#fafafa; border-radius:.3rem;z-index:1000001;";
            strHtml = "<div id='alertTxt' class='popub-txt' style='color:#333;font-size: .9rem!important;padding: 0.5rem .75rem;'>"+txt+"</div>";
