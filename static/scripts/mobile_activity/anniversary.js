...
(function(){
    window.alert = function(txt, callback){
        if(document.getElementById("alert-cont")){
            ...
            strHtml = "<div id='alertTxt' class='popub-txt' style='color:#333;font-size: .9rem!important;'>"+txt+"</div>";
            strHtml +="<div style='text-align: center;width:100%;padding:0.5rem 0 1rem'><div class=\"popub-footer\" style=\"width: 6.425rem;height: 1.3rem;display: inline-block;text-align: center;font-size: 0.7rem;border-radius: 0.5rem;background: #fc8305;color: #ffffff;;line-height: 1.3rem;text-decoration: none\" onclick=\"doOk()\">知道了</div></div>";
