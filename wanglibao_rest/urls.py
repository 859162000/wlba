...
from wanglibao_account.views import (ResetPasswordAPI, FundInfoAPIView, AccountHomeAPIView,
                                     AccountP2PRecordAPI, AccountP2PAssetAPI, LoginCounterVerifyAPI,
                                     P2PAmortizationAPI, UserProductContract, ChangePasswordAPIView, AddressAPIView,
                                     AddressListAPIView, AddressDeleteAPIView, AddressGetAPIView, AccountInviteAPIView,
                                     MessageListAPIView, MessageCountAPIView, MessageDetailAPIView, AutomaticApiView,
                                     AccountInviteHikeAPIView,AccountInviteAllGoldAPIView, AccountInviteIncomeAPIView,
                                     PasswordCheckView, ManualModifyPhoneAPI,
                                     ValidateAccountInfoAPI, SMSModifyPhoneValidateAPI, SMSModifyPhoneAPI,
                                     ModifyPhoneValidateCode, CancelManualModifyPhoneAPI)
...
# from wanglibao_buy.views import TradeInfoViewSet, TotalIncome
...
from wanglibao_reward.views import (JiaKeAPIView, BaoGeAPIView, XiaoMeiAPIView,ZhongYingAPIView, WeixinRedPackView, WeixinShareTools, DistributeRewardAPIView, XunleiActivityAPIView,
                                    ...
                                    Lantern_FetchRewardAPI, FetchMarchAwardAPI, XunleiTreasureAPIView, RuiKeAPIView, JulyAwardApi,
...
urlpatterns += patterns(
    ...
    url(r'^weixin/distribute/redpack/$', RewardDistributeAPIView.as_view()), #add by yihen 微信大转盘
    ...
    url(r'^activity/chefangdai/$', CheFangDaiAPIView.as_view()),
    url(r'^activity/chefangdaiuserinfo/$', CheFangDaiUserInfoAPIView.as_view()),
    ...
    url(r'^july_reward/fetch/$', JulyAwardApi.as_view()),  #七月活动
)
