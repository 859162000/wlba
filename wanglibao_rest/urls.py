...
from marketing.views import (ActivityJoinLogAPIView, ActivityJoinLogCountAPIView, ThousandRedPackAPIView,
                             ThousandRedPackCountAPIView, ThunderActivityRewardCounter, QuickApplyer, GiftOwnerInfo)
...
urlpatterns += patterns(
    ...
    url(r'^gift/owner/$', GiftOwnerInfo.as_view()), #add by yihen@20151102 ,聚橙网领取门票接口
)
