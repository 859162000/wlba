...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPhoneBook'
        db.create_table(u'wanglibao_account_userphonebook', (
            ...
            ('is_register', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_invite', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('invite_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('alert_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 26, 0, 0), auto_now_add=True, blank=True)),
            ('is_used', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'wanglibao_account', ['UserPhoneBook'])


        # Changing field 'Binding.btype'
        db.alter_column(u'wanglibao_account_binding', 'btype', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Deleting model 'UserPhoneBook'
        db.delete_table(u'wanglibao_account_userphonebook')


        # Changing field 'Binding.btype'
        db.alter_column(u'wanglibao_account_binding', 'btype', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1440559834L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invite_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
