...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdVerification.update_verify'
        db.add_column(u'wanglibao_account_idverification', 'update_verify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdVerification.update_verify'
        db.delete_column(u'wanglibao_account_idverification', 'update_verify')
    ...
    models = {
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1447757138L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
