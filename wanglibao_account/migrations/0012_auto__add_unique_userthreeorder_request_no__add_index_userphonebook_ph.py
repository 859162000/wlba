...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserThreeOrder', fields ['request_no']
        db.create_unique(u'wanglibao_account_userthreeorder', ['request_no'])

        # Adding index on 'UserPhoneBook', fields ['phone']
        db.create_index(u'wanglibao_account_userphonebook', ['phone'])

        # Adding index on 'UserPhoneBook', fields ['invite_at']
        db.create_index(u'wanglibao_account_userphonebook', ['invite_at'])


    def backwards(self, orm):
        # Removing index on 'UserPhoneBook', fields ['invite_at']
        db.delete_index(u'wanglibao_account_userphonebook', ['invite_at'])

        # Removing index on 'UserPhoneBook', fields ['phone']
        db.delete_index(u'wanglibao_account_userphonebook', ['phone'])

        # Removing unique constraint on 'UserThreeOrder', fields ['request_no']
        db.delete_unique(u'wanglibao_account_userthreeorder', ['request_no'])
    ...
    models = {
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1443073393L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
