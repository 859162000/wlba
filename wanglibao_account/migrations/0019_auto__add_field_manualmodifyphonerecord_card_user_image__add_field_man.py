...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManualModifyPhoneRecord.card_user_image'
        db.add_column(u'wanglibao_account_manualmodifyphonerecord', 'card_user_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ManualModifyPhoneRecord.id_front_image_status'
        db.add_column(u'wanglibao_account_manualmodifyphonerecord', 'id_front_image_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ManualModifyPhoneRecord.id_back_image_status'
        db.add_column(u'wanglibao_account_manualmodifyphonerecord', 'id_back_image_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ManualModifyPhoneRecord.id_user_image_status'
        db.add_column(u'wanglibao_account_manualmodifyphonerecord', 'id_user_image_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ManualModifyPhoneRecord.card_user_image_status'
        db.add_column(u'wanglibao_account_manualmodifyphonerecord', 'card_user_image_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManualModifyPhoneRecord.card_user_image'
        db.delete_column(u'wanglibao_account_manualmodifyphonerecord', 'card_user_image')

        # Deleting field 'ManualModifyPhoneRecord.id_front_image_status'
        db.delete_column(u'wanglibao_account_manualmodifyphonerecord', 'id_front_image_status')

        # Deleting field 'ManualModifyPhoneRecord.id_back_image_status'
        db.delete_column(u'wanglibao_account_manualmodifyphonerecord', 'id_back_image_status')

        # Deleting field 'ManualModifyPhoneRecord.id_user_image_status'
        db.delete_column(u'wanglibao_account_manualmodifyphonerecord', 'id_user_image_status')

        # Deleting field 'ManualModifyPhoneRecord.card_user_image_status'
        db.delete_column(u'wanglibao_account_manualmodifyphonerecord', 'card_user_image_status')
    ...
    models = {
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1457418222L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
