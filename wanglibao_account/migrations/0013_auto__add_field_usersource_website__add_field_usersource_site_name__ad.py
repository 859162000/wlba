...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'wanglibao_account_usersource', 'site_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'UserSource.action'
        db.add_column(u'wanglibao_account_usersource', 'action',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=128),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserSource.site_name'
        db.delete_column(u'wanglibao_account_usersource', 'site_name')

        # Deleting field 'UserSource.action'
        db.delete_column(u'wanglibao_account_usersource', 'action')

        # Deleting field 'UserSource.created_at'
        db.delete_column(u'wanglibao_account_usersource', 'created_at')
    ...
    models = {
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 11, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
