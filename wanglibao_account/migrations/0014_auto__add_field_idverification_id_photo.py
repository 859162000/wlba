...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdVerification.id_photo'
        db.add_column(u'wanglibao_account_idverification', 'id_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdVerification.id_photo'
        db.delete_column(u'wanglibao_account_idverification', 'id_photo')
