...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Binding.detect_callback'
        db.add_column(u'wanglibao_account_binding', 'detect_callback',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Binding.detect_callback'
        db.delete_column(u'wanglibao_account_binding', 'detect_callback')
    ...
    models = {
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1447924397L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
