...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VerifyCounter'
        db.create_table(u'wanglibao_account_verifycounter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'wanglibao_account', ['VerifyCounter'])


    def backwards(self, orm):
        # Deleting model 'VerifyCounter'
        db.delete_table(u'wanglibao_account_verifycounter')
