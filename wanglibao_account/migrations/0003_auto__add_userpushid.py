...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserPushId'
        db.create_table(u'wanglibao_account_userpushid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('device_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('push_user_id', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('push_channel_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'wanglibao_account', ['UserPushId'])


    def backwards(self, orm):
        # Deleting model 'UserPushId'
        db.delete_table(u'wanglibao_account_userpushid')
