...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserThreeOrder.created_at'
        db.alter_column(u'wanglibao_account_userthreeorder', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Binding.baccount'
        db.alter_column(u'wanglibao_account_binding', 'baccount', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'UserThreeOrder.created_at'
        db.alter_column(u'wanglibao_account_userthreeorder', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Binding.baccount'
        db.alter_column(u'wanglibao_account_binding', 'baccount', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
    ...
    models = {
        ...
        u'wanglibao_account.binding': {
            ...
            'baccount': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1464152236L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
