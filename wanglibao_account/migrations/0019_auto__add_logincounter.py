...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LoginCounter'
        db.create_table(u'wanglibao_account_logincounter', (
        ...
        db.send_create_signal(u'wanglibao_account', ['LoginCounter'])


    def backwards(self, orm):
        # Deleting model 'LoginCounter'
        db.delete_table(u'wanglibao_account_logincounter')
    ...
    models = {
        ...
        u'wanglibao_account.logincounter': {
            'Meta': {'object_name': 'LoginCounter'},
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1456208334L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 23, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
