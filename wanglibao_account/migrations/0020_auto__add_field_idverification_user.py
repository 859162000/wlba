...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IdVerification.user'
        db.add_column(u'wanglibao_account_idverification', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IdVerification.user'
        db.delete_column(u'wanglibao_account_idverification', 'user_id')
    ...
    models = {
        ...
        u'wanglibao_account.messagetext': {
            ...
            'created_at': ('django.db.models.fields.BigIntegerField', [], {'default': '1458373052L', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mtype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'db_index': 'True'}),
        ...
        u'wanglibao_account.userphonebook': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
