...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_account_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('target_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recive', to=orm['auth.User'])),
            ('message_text', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_account.MessageText'])),
            ('read_status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('read_at', self.gf('django.db.models.fields.BigIntegerField')(default=0, blank=True)),
            ('notice', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'wanglibao_account', ['Message'])

        # Adding model 'MessageText'
        db.create_table(u'wanglibao_account_messagetext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mtype', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('created_at', self.gf('django.db.models.fields.BigIntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_account', ['MessageText'])

        # Adding model 'MessageNoticeSet'
        db.create_table(u'wanglibao_account_messagenoticeset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notice', to=orm['auth.User'])),
            ('mtype', self.gf('django.db.models.fields.CharField')(max_length=50, db_index=True)),
            ('notice', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'wanglibao_account', ['MessageNoticeSet'])


    def backwards(self, orm):
        # Deleting model 'Message'
        db.delete_table(u'wanglibao_account_message')

        # Deleting model 'MessageText'
        db.delete_table(u'wanglibao_account_messagetext')

        # Deleting model 'MessageNoticeSet'
        db.delete_table(u'wanglibao_account_messagenoticeset')
