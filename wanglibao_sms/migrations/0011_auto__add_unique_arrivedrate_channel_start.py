...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ArrivedRate', fields ['channel', 'start']
        db.create_unique(u'wanglibao_sms_arrivedrate', ['channel', 'start'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArrivedRate', fields ['channel', 'start']
        db.delete_unique(u'wanglibao_sms_arrivedrate', ['channel', 'start'])
