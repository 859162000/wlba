...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShortMessage.channel'
        db.add_column(u'wanglibao_sms_shortmessage', 'channel',
                      self.gf('django.db.models.fields.CharField')(default=u'\u6162\u9053', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShortMessage.channel'
        db.delete_column(u'wanglibao_sms_shortmessage', 'channel')
