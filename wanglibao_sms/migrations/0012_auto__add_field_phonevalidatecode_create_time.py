...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhoneValidateCode.create_time'
        db.add_column(u'wanglibao_sms_phonevalidatecode', 'create_time',
                      self.gf('django.db.models.fields.DateTimeField')(default='2015-12-01T00:00:00+08:00', db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhoneValidateCode.create_time'
        db.delete_column(u'wanglibao_sms_phonevalidatecode', 'create_time')
