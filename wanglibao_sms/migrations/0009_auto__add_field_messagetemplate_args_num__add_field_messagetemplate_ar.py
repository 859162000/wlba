...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessageTemplate.args_num'
        db.add_column(u'wanglibao_sms_messagetemplate', 'args_num',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'MessageTemplate.args_tips'
        db.add_column(u'wanglibao_sms_messagetemplate', 'args_tips',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


        # Changing field 'ArrivedRate.rate'
        db.alter_column(u'wanglibao_sms_arrivedrate', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):
        # Deleting field 'MessageTemplate.args_num'
        db.delete_column(u'wanglibao_sms_messagetemplate', 'args_num')

        # Deleting field 'MessageTemplate.args_tips'
        db.delete_column(u'wanglibao_sms_messagetemplate', 'args_tips')


        # Changing field 'ArrivedRate.rate'
        db.alter_column(u'wanglibao_sms_arrivedrate', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))
