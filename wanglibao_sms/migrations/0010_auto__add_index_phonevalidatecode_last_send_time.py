...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'PhoneValidateCode', fields ['last_send_time']
        db.create_index(u'wanglibao_sms_phonevalidatecode', ['last_send_time'])


    def backwards(self, orm):
        # Removing index on 'PhoneValidateCode', fields ['last_send_time']
        db.delete_index(u'wanglibao_sms_phonevalidatecode', ['last_send_time'])
