...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_sms_messagetemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message_for', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32, db_index=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'wanglibao_sms', ['MessageTemplate'])


    def backwards(self, orm):
        # Deleting model 'MessageTemplate'
        db.delete_table(u'wanglibao_sms_messagetemplate')
