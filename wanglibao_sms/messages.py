...
def jiuxian_invited(money):
    return u'感谢你接受酒仙网的邀请注册网利宝并成功购买理财产品！网利宝将奖励你%s元手机话费，5个工作日内将直接充值到你的注册手机号。' \
           % money
...
def msg_jiuxian(phone):
    title = u"邀请好友送话费"
    content =  u'亲爱的您好：<br>您已成功接受酒仙网的邀请注册网利宝并购买成功！您将获得30元话费，您的30元话费将于3个工作日内充值至您的手机号%s，请注意查收。<br/>感谢您对我们的支持与关注！网利宝' % phone
    return title, content
