...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.shumi_access_token_secret'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'shumi_access_token_secret',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.shumi_access_token_secret'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'shumi_access_token_secret')
