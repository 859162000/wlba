...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_profile_wanglibaouserprofile', (
            ...
            ('phone', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
            ('phone_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('identity_type', self.gf('django.db.models.fields.CharField')(default='id', max_length=10)),
            ('identity', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('risk_level', self.gf('django.db.models.fields.PositiveIntegerField')(default=2)),
            ('investment_asset', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_asset', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    models = {
        ...
        u'wanglibao_profile.wanglibaouserprofile': {
            ...
            'identity_type': ('django.db.models.fields.CharField', [], {'default': "'id'", 'max_length': '10'}),
