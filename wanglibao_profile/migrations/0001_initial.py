...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_profile_wanglibaouserprofile', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True)),
            ('id_number', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, blank=True)),
