...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'gesture_is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.gesture_pwd'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'gesture_pwd')

        # Deleting field 'WanglibaoUserProfile.gesture_is_enabled'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'gesture_is_enabled')
