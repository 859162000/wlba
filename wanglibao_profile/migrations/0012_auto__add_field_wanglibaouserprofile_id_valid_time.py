...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.id_valid_time'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'id_valid_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.id_valid_time'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'id_valid_time')
