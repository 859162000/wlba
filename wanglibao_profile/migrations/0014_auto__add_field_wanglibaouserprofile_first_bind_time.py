...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.first_bind_time'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'first_bind_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.first_bind_time'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'first_bind_time')
