...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.frozen'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'frozen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.frozen'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'frozen')
