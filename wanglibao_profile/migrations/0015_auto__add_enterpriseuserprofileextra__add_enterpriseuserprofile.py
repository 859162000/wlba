...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_profile_enterpriseuserprofileextra', (
        ...
        db.send_create_signal(u'wanglibao_profile', ['EnterpriseUserProfileExtra'])

        # Adding model 'EnterpriseUserProfile'
        db.create_table(u'wanglibao_profile_enterpriseuserprofile', (
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
        ...
        db.send_create_signal(u'wanglibao_profile', ['EnterpriseUserProfile'])


    def backwards(self, orm):
        # Deleting model 'EnterpriseUserProfileExtra'
        db.delete_table(u'wanglibao_profile_enterpriseuserprofileextra')

        # Deleting model 'EnterpriseUserProfile'
        db.delete_table(u'wanglibao_profile_enterpriseuserprofile')
    ...
    models = {
        ...
        u'wanglibao_profile.enterpriseuserprofile': {
        ...
        u'wanglibao_profile.enterpriseuserprofileextra': {
