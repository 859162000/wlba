...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RepeatPaymentUser'
        db.create_table(u'wanglibao_profile_repeatpaymentuser', (
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=2)),
            ('is_every_day', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('product_ids', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_profile', ['RepeatPaymentUser'])

        # Adding model 'RepeatPaymentUserRecords'
        db.create_table(u'wanglibao_profile_repeatpaymentuserrecords', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=2)),
            ('amount_current', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=10, decimal_places=2)),
            ('description', self.gf('django.db.models.fields.CharField')(default=u'', max_length=200)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_profile', ['RepeatPaymentUserRecords'])


    def backwards(self, orm):
        # Deleting model 'RepeatPaymentUser'
        db.delete_table(u'wanglibao_profile_repeatpaymentuser')

        # Deleting model 'RepeatPaymentUserRecords'
        db.delete_table(u'wanglibao_profile_repeatpaymentuserrecords')
    ...
    models = {
        ...
        u'wanglibao_profile.account2015': {
            ...
            'first_visit_ipaddr': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'first_visit_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'last_visit_ipaddr': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
            'last_visit_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'total_visit_count': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        u'wanglibao_profile.activityuserinfo': {
            'Meta': {'object_name': 'ActivityUserInfo'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_wlb_phone': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'wanglibao_profile.repeatpaymentuser': {
            'Meta': {'object_name': 'RepeatPaymentUser'},
            'amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '10', 'decimal_places': '2'}),
            'interest': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'is_every_day': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
            'principal': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'product_ids': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'user_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'})
        },
        u'wanglibao_profile.repeatpaymentuserrecords': {
            'Meta': {'object_name': 'RepeatPaymentUserRecords'},
            'amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '10', 'decimal_places': '2'}),
            'amount_current': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '10', 'decimal_places': '2'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'phone': ('django.db.models.fields.CharField', [], {'max_length': '11'}),
        ...
        u'wanglibao_profile.wanglibaouserprofile': {
            ...
            'login_failed_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'login_failed_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
