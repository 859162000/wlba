...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.deposit_default_bank_name'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'deposit_default_bank_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.deposit_default_bank_name'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'deposit_default_bank_name')
