...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.login_failed_count'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'login_failed_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WanglibaoUserProfile.login_failed_time'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'login_failed_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.login_failed_count'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'login_failed_count')

        # Deleting field 'WanglibaoUserProfile.login_failed_time'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'login_failed_time')
