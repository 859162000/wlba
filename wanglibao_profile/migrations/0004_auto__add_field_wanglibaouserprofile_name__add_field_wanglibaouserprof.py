...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.name'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12, blank=True),
                      keep_default=False)

        # Adding field 'WanglibaoUserProfile.id_number'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'id_number',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'WanglibaoUserProfile.shumi_request_token'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'shumi_request_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'WanglibaoUserProfile.shumi_access_token'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'shumi_access_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.name'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'name')

        # Deleting field 'WanglibaoUserProfile.id_number'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'id_number')

        # Deleting field 'WanglibaoUserProfile.shumi_request_token'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'shumi_request_token')

        # Deleting field 'WanglibaoUserProfile.shumi_access_token'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'shumi_access_token')
