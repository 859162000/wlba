...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account2015.first_visit_time'
        db.add_column(u'wanglibao_profile_account2015', 'first_visit_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Account2015.first_visit_ipaddr'
        db.add_column(u'wanglibao_profile_account2015', 'first_visit_ipaddr',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Account2015.last_visit_time'
        db.add_column(u'wanglibao_profile_account2015', 'last_visit_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Account2015.last_visit_ipaddr'
        db.add_column(u'wanglibao_profile_account2015', 'last_visit_ipaddr',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Account2015.total_visit_count'
        db.add_column(u'wanglibao_profile_account2015', 'total_visit_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account2015.first_visit_time'
        db.delete_column(u'wanglibao_profile_account2015', 'first_visit_time')

        # Deleting field 'Account2015.first_visit_ipaddr'
        db.delete_column(u'wanglibao_profile_account2015', 'first_visit_ipaddr')

        # Deleting field 'Account2015.last_visit_time'
        db.delete_column(u'wanglibao_profile_account2015', 'last_visit_time')

        # Deleting field 'Account2015.last_visit_ipaddr'
        db.delete_column(u'wanglibao_profile_account2015', 'last_visit_ipaddr')

        # Deleting field 'Account2015.total_visit_count'
        db.delete_column(u'wanglibao_profile_account2015', 'total_visit_count')
