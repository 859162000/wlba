...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityUserInfo'
        db.create_table(u'wanglibao_profile_activityuserinfo', (
            ...
            ('is_wlb_phone', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('extra', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_profile', ['ActivityUserInfo'])


    def backwards(self, orm):
        # Deleting model 'ActivityUserInfo'
        db.delete_table(u'wanglibao_profile_activityuserinfo')
