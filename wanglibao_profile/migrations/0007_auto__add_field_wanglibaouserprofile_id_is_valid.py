...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.id_is_valid'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'id_is_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.id_is_valid'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'id_is_valid')
