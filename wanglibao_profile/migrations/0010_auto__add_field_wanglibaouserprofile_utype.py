...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoUserProfile.utype'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'utype',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.utype'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'utype')
