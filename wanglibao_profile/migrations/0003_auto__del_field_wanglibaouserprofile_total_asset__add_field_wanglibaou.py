...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WanglibaoUserProfile.total_asset'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'total_asset')

        # Adding field 'WanglibaoUserProfile.investment_period'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'investment_period',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WanglibaoUserProfile.total_asset'
        db.add_column(u'wanglibao_profile_wanglibaouserprofile', 'total_asset',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'WanglibaoUserProfile.investment_period'
        db.delete_column(u'wanglibao_profile_wanglibaouserprofile', 'investment_period')
