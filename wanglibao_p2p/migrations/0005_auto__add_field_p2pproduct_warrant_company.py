...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.warrant_company'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'warrant_company',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.warrant_company'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'warrant_company')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 27, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 17, 0, 0)', 'db_index': 'True'}),
