...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.baoli_original_contract_number'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'baoli_original_contract_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.baoli_original_contract_name'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'baoli_original_contract_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.baoli_trade_relation'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'baoli_trade_relation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.baoli_original_contract_number'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'baoli_original_contract_number')

        # Deleting field 'P2PProduct.baoli_original_contract_name'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'baoli_original_contract_name')

        # Deleting field 'P2PProduct.baoli_trade_relation'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'baoli_trade_relation')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pequity': {
            ...
            'confirm_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'borrower_address': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            ...
            'borrower_bankcard_bank_name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            ...
            'repaying_source': ('django.db.models.fields.CharField', [], {'max_length': '256', 'blank': 'True'}),
