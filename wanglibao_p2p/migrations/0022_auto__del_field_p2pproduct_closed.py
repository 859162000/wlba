...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'P2PProduct.closed'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'closed')


    def backwards(self, orm):
        # Adding field 'P2PProduct.closed'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'closed',
