...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProductContract.party_b_type'
        db.add_column(u'wanglibao_p2p_p2pproductcontract', 'party_b_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u4f01\u4e1a', max_length=16),
                      keep_default=False)


        # Changing field 'P2PProductContract.bill_due_date'
        db.alter_column(u'wanglibao_p2p_p2pproductcontract', 'bill_due_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'P2PProductContract.party_b_type'
        db.delete_column(u'wanglibao_p2p_p2pproductcontract', 'party_b_type')


        # Changing field 'P2PProductContract.bill_due_date'
        db.alter_column(u'wanglibao_p2p_p2pproductcontract', 'bill_due_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 3, 0, 0)'}),
        ...
        u'wanglibao_p2p.p2pproductcontract': {
            ...
            'bill_due_date': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
