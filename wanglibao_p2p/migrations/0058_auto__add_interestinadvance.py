...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterestInAdvance'
        db.create_table(u'wanglibao_p2p_interestinadvance', (
            ...
            ('interest', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('days', self.gf('django.db.models.fields.IntegerField')()),
            ('subscription_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('product_soldout_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('product_year_rate', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('create_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['InterestInAdvance'])


    def backwards(self, orm):
        # Deleting model 'InterestInAdvance'
        db.delete_table(u'wanglibao_p2p_interestinadvance')
