...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_p2p_marginrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('catalog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.RecordCatalog'])),
        ...
        db.send_create_signal(u'wanglibao_p2p', ['MarginRecord'])

        # Adding model 'RecordCatalog'
        db.create_table(u'wanglibao_p2p_recordcatalog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('catalog_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['RecordCatalog'])
        ...
        # Adding field 'TradeRecord.description'
        db.add_column(u'wanglibao_p2p_traderecord', 'description',
        ...
        # Changing field 'TradeRecord.catalog'
        db.alter_column(u'wanglibao_p2p_traderecord', 'catalog_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.RecordCatalog']))
        # Adding field 'ProductUserAmortization.current_user_equity'
        db.add_column(u'wanglibao_p2p_productuseramortization', 'current_user_equity',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'wanglibao_p2p_marginrecord')

        # Deleting model 'RecordCatalog'
        db.delete_table(u'wanglibao_p2p_recordcatalog')

        # Deleting model 'EquityRecord'
        db.delete_table(u'wanglibao_p2p_equityrecord')

        # Deleting field 'TradeRecord.description'
        db.delete_column(u'wanglibao_p2p_traderecord', 'description')
        ...
        # Changing field 'TradeRecord.catalog'
        db.alter_column(u'wanglibao_p2p_traderecord', 'catalog_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.TradeRecordType']))
        # Deleting field 'ProductUserAmortization.current_user_equity'
        db.delete_column(u'wanglibao_p2p_productuseramortization', 'current_user_equity')
