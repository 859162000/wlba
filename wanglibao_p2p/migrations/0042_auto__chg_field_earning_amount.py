...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Earning.amount'
        db.alter_column(u'wanglibao_p2p_earning', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))

    def backwards(self, orm):

        # Changing field 'Earning.amount'
        db.alter_column(u'wanglibao_p2p_earning', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))
    ...
    models = {
        ...
        u'marketing.activity': {
            ...
            'rule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marketing.ActivityRule']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'marketing.activityrule': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'rule_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '8'}),
        ...
        u'wanglibao_p2p.earning': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '8'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
