...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'P2PProductContract.bill_due_date'
        db.delete_column(u'wanglibao_p2p_p2pproductcontract', 'bill_due_date')


    def backwards(self, orm):
        # Adding field 'P2PProductContract.bill_due_date'
        db.add_column(u'wanglibao_p2p_p2pproductcontract', 'bill_due_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 1, 27, 0, 0), blank=True),
                      keep_default=False)
