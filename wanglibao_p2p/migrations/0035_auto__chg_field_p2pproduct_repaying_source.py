...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'P2PProduct.repaying_source'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'repaying_source', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'P2PProduct.repaying_source'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'repaying_source', self.gf('django.db.models.fields.CharField')(max_length=256))
