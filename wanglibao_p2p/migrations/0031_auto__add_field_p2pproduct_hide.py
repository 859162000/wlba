...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.hide'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'hide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.hide'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'hide')
