...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_p2p_p2pproduct', (
            ...
            ('types', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('serial_number', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True, null=True)),
            ...
            ('publish_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 21, 0, 0), db_index=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 31, 0, 0))),
        ...
        db.create_table(u'wanglibao_p2p_p2precord', (
            ...
            ('platform', self.gf('django.db.models.fields.CharField')(default=u'\u624b\u52a8\u6295\u6807', max_length=100)),
        ))
    ...
    models = {
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 31, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 21, 0, 0)', 'db_index': 'True'}),
