...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_p2p_p2pproduct', (
            ...
            ('publish_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 15, 0, 0), db_index=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 3, 25, 0, 0))),
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 25, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 15, 0, 0)', 'db_index': 'True'}),
