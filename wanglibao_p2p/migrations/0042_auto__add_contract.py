...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_p2p_contract', (
            ...
            ('equity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='equity_contract', null=True, on_delete=models.SET_NULL, to=orm['wanglibao_p2p.P2PEquity'])),
    ...
    models = {
        ...
        u'wanglibao_p2p.contract': {
            ...
            'equity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'equity_contract'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['wanglibao_p2p.P2PEquity']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
