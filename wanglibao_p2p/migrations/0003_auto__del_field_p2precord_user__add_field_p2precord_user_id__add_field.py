...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'P2PRecord.user'
        db.delete_column(u'wanglibao_p2p_p2precord', 'user_id')

        # Adding field 'P2PRecord.user_id'
        db.add_column(u'wanglibao_p2p_p2precord', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'UserAmortization.equity_amount'
        db.add_column(u'wanglibao_p2p_useramortization', 'equity_amount',
                      self.gf('django.db.models.fields.DecimalField')(default='', max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'UserAmortization.equity_confirm_at'
        db.add_column(u'wanglibao_p2p_useramortization', 'equity_confirm_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'P2PRecord.user'
        db.add_column(u'wanglibao_p2p_p2precord', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)

        # Deleting field 'P2PRecord.user_id'
        db.delete_column(u'wanglibao_p2p_p2precord', 'user_id')

        # Deleting field 'UserAmortization.equity_amount'
        db.delete_column(u'wanglibao_p2p_useramortization', 'equity_amount')

        # Deleting field 'UserAmortization.equity_confirm_at'
        db.delete_column(u'wanglibao_p2p_useramortization', 'equity_confirm_at')
    ...
    models = {
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 30, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 20, 0, 0)', 'db_index': 'True'}),
