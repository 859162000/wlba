...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'InterestPrecisionBalance', fields ['equity']
        db.delete_unique(u'wanglibao_p2p_interestprecisionbalance', ['equity_id'])


        # Changing field 'InterestPrecisionBalance.equity'
        db.alter_column(u'wanglibao_p2p_interestprecisionbalance', 'equity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wanglibao_p2p.P2PEquity']))

    def backwards(self, orm):

        # Changing field 'InterestPrecisionBalance.equity'
        db.alter_column(u'wanglibao_p2p_interestprecisionbalance', 'equity_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['wanglibao_p2p.P2PEquity']))
        # Adding unique constraint on 'InterestPrecisionBalance', fields ['equity']
        db.create_unique(u'wanglibao_p2p_interestprecisionbalance', ['equity_id'])
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 2, 0, 0)'}),
