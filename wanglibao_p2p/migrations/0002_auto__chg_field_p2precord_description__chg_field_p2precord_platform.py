...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'P2PRecord.description'
        db.alter_column(u'wanglibao_p2p_p2precord', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'P2PRecord.platform'
        db.alter_column(u'wanglibao_p2p_p2precord', 'platform', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'P2PRecord.description'
        db.alter_column(u'wanglibao_p2p_p2precord', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))

        # Changing field 'P2PRecord.platform'
        db.alter_column(u'wanglibao_p2p_p2precord', 'platform', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 2, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 3, 23, 0, 0)', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2precord': {
            ...
            'platform': ('django.db.models.fields.CharField', [], {'default': "u'\\u624b\\u52a8\\u6295\\u6807'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
