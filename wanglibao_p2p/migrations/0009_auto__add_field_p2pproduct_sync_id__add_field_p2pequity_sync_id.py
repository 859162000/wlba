...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.sync_id'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'sync_id',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'P2PEquity.sync_id'
        db.add_column(u'wanglibao_p2p_p2pequity', 'sync_id',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.sync_id'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'sync_id')

        # Deleting field 'P2PEquity.sync_id'
        db.delete_column(u'wanglibao_p2p_p2pequity', 'sync_id')
    ...
    models = {
        ...
        u'wanglibao_margin.marginrecord': {
            ...
            'user_id': ('django.db.models.fields.IntegerField', [], {'max_length': '50', 'db_index': 'True'})
        },
        u'wanglibao_p2p.p2pequity': {
            ...
            'unpaid_principal': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 11, 0, 0)'}),
            ...
            'flow_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 21, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 1, 0, 0)', 'db_index': 'True'}),
