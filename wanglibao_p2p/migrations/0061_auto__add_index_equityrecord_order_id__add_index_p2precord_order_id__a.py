...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EquityRecord', fields ['order_id']
        db.create_index(u'wanglibao_p2p_equityrecord', ['order_id'])

        # Adding index on 'P2PRecord', fields ['order_id']
        db.create_index(u'wanglibao_p2p_p2precord', ['order_id'])

        # Adding index on 'AmortizationRecord', fields ['order_id']
        db.create_index(u'wanglibao_p2p_amortizationrecord', ['order_id'])

        # Adding index on 'AmortizationRecord', fields ['catalog']
        db.create_index(u'wanglibao_p2p_amortizationrecord', ['catalog'])


    def backwards(self, orm):
        # Removing index on 'AmortizationRecord', fields ['catalog']
        db.delete_index(u'wanglibao_p2p_amortizationrecord', ['catalog'])

        # Removing index on 'AmortizationRecord', fields ['order_id']
        db.delete_index(u'wanglibao_p2p_amortizationrecord', ['order_id'])

        # Removing index on 'P2PRecord', fields ['order_id']
        db.delete_index(u'wanglibao_p2p_p2precord', ['order_id'])

        # Removing index on 'EquityRecord', fields ['order_id']
        db.delete_index(u'wanglibao_p2p_equityrecord', ['order_id'])
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 17, 0, 0)'}),
