...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.amortization_count'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'amortization_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.amortization_count'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'amortization_count')
