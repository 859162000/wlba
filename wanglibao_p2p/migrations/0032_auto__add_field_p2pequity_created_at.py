...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PEquity.created_at'
        db.add_column(u'wanglibao_p2p_p2pequity', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PEquity.created_at'
        db.delete_column(u'wanglibao_p2p_p2pequity', 'created_at')
