...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EquityRecord.order_id'
        db.add_column(u'wanglibao_p2p_equityrecord', 'order_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EquityRecord.order_id'
        db.delete_column(u'wanglibao_p2p_equityrecord', 'order_id')
