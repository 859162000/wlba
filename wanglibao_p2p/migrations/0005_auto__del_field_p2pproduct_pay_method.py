...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'P2PProduct.pay_method'
        raise RuntimeError("Cannot reverse this migration. 'P2PProduct.pay_method' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'P2PProduct.pay_method'
