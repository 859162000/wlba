...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PRecord.margin_record'
        db.add_column(u'wanglibao_p2p_p2precord', 'margin_record',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_margin.MarginRecord'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PRecord.margin_record'
        db.delete_column(u'wanglibao_p2p_p2precord', 'margin_record_id')
