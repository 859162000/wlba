...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductAmortization.product'
        db.alter_column(u'wanglibao_p2p_productamortization', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wanglibao_p2p.P2PProduct']))

    def backwards(self, orm):

        # Changing field 'ProductAmortization.product'
        db.alter_column(u'wanglibao_p2p_productamortization', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2015, 3, 6, 0, 0), to=orm['wanglibao_p2p.P2PProduct']))
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 13, 0, 0)'}),
