...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.priority'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.priority'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'priority')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'repaying_source': ('django.db.models.fields.TextField', [], {}),
