...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'P2PEquity.unpaid_principal'
        db.delete_column(u'wanglibao_p2p_p2pequity', 'unpaid_principal')


    def backwards(self, orm):
        # Adding field 'P2PEquity.unpaid_principal'
        db.add_column(u'wanglibao_p2p_p2pequity', 'unpaid_principal',
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 13, 0, 0)'}),
            ...
            'flow_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 23, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 3, 0, 0)', 'db_index': 'True'}),
