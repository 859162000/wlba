...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'P2PProduct.payment'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'payment_id')

        # Adding field 'P2PProduct.pay_method'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'pay_method',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'P2PProduct.payment'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.P2PProductPayment'], null=True),
                      keep_default=False)

        # Deleting field 'P2PProduct.pay_method'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'pay_method')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'pay_method': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
