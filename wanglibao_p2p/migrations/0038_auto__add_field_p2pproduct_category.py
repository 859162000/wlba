...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.category'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'category',
                      self.gf('django.db.models.fields.CharField')(default=u'\u666e\u901a', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.category'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'category')
