...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.excess_earning_description'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'excess_earning_description',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.excess_earning_description'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'excess_earning_description')
