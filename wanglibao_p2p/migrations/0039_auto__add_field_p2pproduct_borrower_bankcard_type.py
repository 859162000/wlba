...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.borrower_bankcard_type'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.borrower_bankcard_type'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_type')
