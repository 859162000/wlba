...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PRecord.invest_end_time'
        db.add_column(u'wanglibao_p2p_p2precord', 'invest_end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'P2PRecord.back_last_date'
        db.add_column(u'wanglibao_p2p_p2precord', 'back_last_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PRecord.invest_end_time'
        db.delete_column(u'wanglibao_p2p_p2precord', 'invest_end_time')

        # Deleting field 'P2PRecord.back_last_date'
        db.delete_column(u'wanglibao_p2p_p2precord', 'back_last_date')
