...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.flow_time'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'flow_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2016, 4, 8, 0, 0), db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.flow_time'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'flow_time')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 28, 0, 0)'}),
            ...
            'flow_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 8, 0, 0)', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 18, 0, 0)', 'db_index': 'True'}),
            ...
            'warrant_company': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
