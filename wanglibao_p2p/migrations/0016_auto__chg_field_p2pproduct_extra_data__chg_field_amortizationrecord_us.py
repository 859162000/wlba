...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'P2PProduct.extra_data'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'extra_data', self.gf('wanglibao.fields.JSONFieldUtf8')())

        # Changing field 'AmortizationRecord.user'
        db.alter_column(u'wanglibao_p2p_amortizationrecord', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'P2PProduct.extra_data'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'extra_data', self.gf('jsonfield.fields.JSONField')())

        # User chose to not deal with backwards NULL issues for 'AmortizationRecord.user'
        raise RuntimeError("Cannot reverse this migration. 'AmortizationRecord.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AmortizationRecord.user'
        db.alter_column(u'wanglibao_p2p_amortizationrecord', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
