...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InterestPrecisionBalance.interest_receivable'
        db.alter_column(u'wanglibao_p2p_interestprecisionbalance', 'interest_receivable', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))

        # Changing field 'InterestPrecisionBalance.interest_actual'
        db.alter_column(u'wanglibao_p2p_interestprecisionbalance', 'interest_actual', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'InterestPrecisionBalance.interest_receivable'
        db.alter_column(u'wanglibao_p2p_interestprecisionbalance', 'interest_receivable', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2))

        # Changing field 'InterestPrecisionBalance.interest_actual'
        db.alter_column(u'wanglibao_p2p_interestprecisionbalance', 'interest_actual', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8))
