...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contract.version'
        db.delete_column(u'wanglibao_p2p_contract', 'version')


    def backwards(self, orm):
        # Adding field 'Contract.version'
        db.add_column(u'wanglibao_p2p_contract', 'version',
