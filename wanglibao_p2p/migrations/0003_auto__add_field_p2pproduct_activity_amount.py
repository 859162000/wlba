...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.activity_amount'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'activity_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.activity_amount'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'activity_amount')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            'Meta': {'ordering': "['-sync_id', '-id']", 'object_name': 'P2PProduct'},
            'activity_amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '20', 'decimal_places': '4'}),
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 8, 0, 0)'}),
            ...
            'flow_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 19, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 29, 0, 0)', 'db_index': 'True'}),
