...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Warrant.name'
        db.alter_column(u'wanglibao_p2p_warrant', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Warrant.name'
        db.alter_column(u'wanglibao_p2p_warrant', 'name', self.gf('django.db.models.fields.CharField')(max_length=16))
