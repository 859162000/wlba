...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'P2PProduct.version'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'version', self.gf('django.db.models.fields.IntegerField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'P2PProduct.version'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'version', self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace=''))
    ...
    models = {
        u'wanglibao_p2p.p2pproduct': {
            ...
            'version': ('django.db.models.fields.IntegerField', [], {'max_length': '50'})
        },
