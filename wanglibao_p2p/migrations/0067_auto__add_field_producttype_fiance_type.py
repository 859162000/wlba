...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductType.fiance_type'
        db.add_column(u'wanglibao_p2p_producttype', 'fiance_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u4ea7\u878d\u901a', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductType.fiance_type'
        db.delete_column(u'wanglibao_p2p_producttype', 'fiance_type')
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 21, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
