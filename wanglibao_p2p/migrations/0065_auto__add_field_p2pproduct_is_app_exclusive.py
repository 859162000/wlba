...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.is_app_exclusive'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'is_app_exclusive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.is_app_exclusive'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'is_app_exclusive')
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 30, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 20, 0, 0)'}),
