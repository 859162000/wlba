...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAmortization.coupon_interest'
        db.add_column(u'wanglibao_p2p_useramortization', 'coupon_interest',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'AmortizationRecord.coupon_interest'
        db.add_column(u'wanglibao_p2p_amortizationrecord', 'coupon_interest',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAmortization.coupon_interest'
        db.delete_column(u'wanglibao_p2p_useramortization', 'coupon_interest')

        # Deleting field 'AmortizationRecord.coupon_interest'
        db.delete_column(u'wanglibao_p2p_amortizationrecord', 'coupon_interest')
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
