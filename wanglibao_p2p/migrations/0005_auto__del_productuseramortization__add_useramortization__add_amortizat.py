...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AmortizationRecord'
        db.create_table(u'wanglibao_p2p_amortizationrecord', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('penal_interest', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['AmortizationRecord'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AmortizationRecord'
        db.delete_table(u'wanglibao_p2p_amortizationrecord')
    ...
    models = {
        ...
        u'wanglibao_p2p.useramortization': {
            'Meta': {'object_name': 'UserAmortization'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
