...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.borrower_bankcard_bank_name'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.borrower_bankcard_bank_name'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_name')
