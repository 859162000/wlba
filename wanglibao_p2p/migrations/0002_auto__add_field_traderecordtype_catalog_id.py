...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TradeRecordType.catalog_id'
        db.add_column(u'wanglibao_p2p_traderecordtype', 'catalog_id',
                      self.gf('django.db.models.fields.IntegerField')(unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TradeRecordType.catalog_id'
        db.delete_column(u'wanglibao_p2p_traderecordtype', 'catalog_id')
