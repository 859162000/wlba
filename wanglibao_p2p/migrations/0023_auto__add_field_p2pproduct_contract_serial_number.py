...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.contract_serial_number'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'contract_serial_number',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.contract_serial_number'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'contract_serial_number')
