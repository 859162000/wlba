...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'wanglibao_p2p_contract')

        # Adding model 'P2PContract'
        db.create_table(u'wanglibao_p2p_p2pcontract', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract_path', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('equity', self.gf('django.db.models.fields.related.OneToOneField')(related_name='equity_contract', unique=True, null=True, to=orm['wanglibao_p2p.P2PEquity'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['P2PContract'])


    def backwards(self, orm):
        # Adding model 'Contract'
        db.create_table(u'wanglibao_p2p_contract', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True)),
            ('contract_path', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
            ('equity', self.gf('django.db.models.fields.related.OneToOneField')(related_name='equity_contract', unique=True, null=True, to=orm['wanglibao_p2p.P2PEquity'])),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['Contract'])

        # Deleting model 'P2PContract'
        db.delete_table(u'wanglibao_p2p_p2pcontract')
