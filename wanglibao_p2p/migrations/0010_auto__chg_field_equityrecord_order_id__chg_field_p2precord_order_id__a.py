...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EquityRecord.order_id'
        db.alter_column(u'wanglibao_p2p_equityrecord', 'order_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'P2PRecord.order_id'
        db.alter_column(u'wanglibao_p2p_p2precord', 'order_id', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Adding field 'AmortizationRecord.order_id'
        db.add_column(u'wanglibao_p2p_amortizationrecord', 'order_id',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EquityRecord.order_id'
        raise RuntimeError("Cannot reverse this migration. 'EquityRecord.order_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EquityRecord.order_id'
        db.alter_column(u'wanglibao_p2p_equityrecord', 'order_id', self.gf('django.db.models.fields.IntegerField')())

        # User chose to not deal with backwards NULL issues for 'P2PRecord.order_id'
        raise RuntimeError("Cannot reverse this migration. 'P2PRecord.order_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'P2PRecord.order_id'
        db.alter_column(u'wanglibao_p2p_p2precord', 'order_id', self.gf('django.db.models.fields.IntegerField')())
        # Deleting field 'AmortizationRecord.order_id'
        db.delete_column(u'wanglibao_p2p_amortizationrecord', 'order_id')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pequity': {
            ...
            'next_term': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
