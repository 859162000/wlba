...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAmortization.version'
        db.add_column(u'wanglibao_p2p_useramortization', 'version',
                      self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace=''),
                      keep_default=False)

        # Adding field 'P2PEquity.version'
        db.add_column(u'wanglibao_p2p_p2pequity', 'version',
                      self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace=''),
                      keep_default=False)

        # Adding field 'ProductAmortization.version'
        db.add_column(u'wanglibao_p2p_productamortization', 'version',
                      self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAmortization.version'
        db.delete_column(u'wanglibao_p2p_useramortization', 'version')

        # Deleting field 'P2PEquity.version'
        db.delete_column(u'wanglibao_p2p_p2pequity', 'version')

        # Deleting field 'ProductAmortization.version'
        db.delete_column(u'wanglibao_p2p_productamortization', 'version')
