...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_p2p_producttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('priority', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['ProductType'])

        # Adding field 'P2PProduct.types'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'types',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_p2p.ProductType'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ProductType'
        db.delete_table(u'wanglibao_p2p_producttype')

        # Deleting field 'P2PProduct.types'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'types_id')
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
