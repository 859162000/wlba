...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'wanglibao_p2p_productamortization', 'term_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 24, 0, 0)),
                      keep_default=False)

        # Adding field 'ProductAmortization.ready_for_settle'
        db.add_column(u'wanglibao_p2p_productamortization', 'ready_for_settle',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductAmortization.term_date'
        db.delete_column(u'wanglibao_p2p_productamortization', 'term_date')

        # Deleting field 'ProductAmortization.ready_for_settle'
        db.delete_column(u'wanglibao_p2p_productamortization', 'ready_for_settle')
