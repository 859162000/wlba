...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'P2PProduct.flow_time'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'flow_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'P2PProduct.flow_time'
        db.alter_column(u'wanglibao_p2p_p2pproduct', 'flow_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 2, 0, 0)'}),
            ...
            'flow_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 12, 0, 0)', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 22, 0, 0)', 'db_index': 'True'}),
