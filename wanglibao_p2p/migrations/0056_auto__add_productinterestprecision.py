...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductInterestPrecision'
        db.create_table(u'wanglibao_p2p_productinterestprecision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='interest_precision_balance', null=True, to=orm['wanglibao_p2p.P2PProduct'])),
            ('principal', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('interest_receivable', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8)),
            ('interest_actual', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('interest_precision_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['ProductInterestPrecision'])


    def backwards(self, orm):
        # Deleting model 'ProductInterestPrecision'
        db.delete_table(u'wanglibao_p2p_productinterestprecision')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 5, 0, 0)'}),
