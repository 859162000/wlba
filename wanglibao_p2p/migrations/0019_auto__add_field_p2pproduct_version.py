...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.version'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'version',
                      self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.version'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'version')
