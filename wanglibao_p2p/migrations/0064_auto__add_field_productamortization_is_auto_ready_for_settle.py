...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductAmortization.is_auto_ready_for_settle'
        db.add_column(u'wanglibao_p2p_productamortization', 'is_auto_ready_for_settle',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductAmortization.is_auto_ready_for_settle'
        db.delete_column(u'wanglibao_p2p_productamortization', 'is_auto_ready_for_settle')
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 19, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 9, 0, 0)'}),
