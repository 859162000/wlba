...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.borrower_name'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_phone'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_id_number'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_id_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_bankcard'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_bankcard_bank_code'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_bankcard_bank_province'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_province',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_bankcard_bank_city'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_bankcard_bank_branch'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_branch',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.soldout_time'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'soldout_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.borrower_name'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_name')

        # Deleting field 'P2PProduct.borrower_phone'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_phone')

        # Deleting field 'P2PProduct.borrower_id_number'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_id_number')

        # Deleting field 'P2PProduct.borrower_bankcard'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard')

        # Deleting field 'P2PProduct.borrower_bankcard_bank_code'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_code')

        # Deleting field 'P2PProduct.borrower_bankcard_bank_province'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_province')

        # Deleting field 'P2PProduct.borrower_bankcard_bank_city'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_city')

        # Deleting field 'P2PProduct.borrower_bankcard_bank_branch'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_bankcard_bank_branch')

        # Deleting field 'P2PProduct.soldout_time'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'soldout_time')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'borrower_bankcard': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            ...
            'borrower_bankcard_bank_code': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'borrower_bankcard_bank_province': ('django.db.models.fields.CharField', [], {'max_length': '64', 'blank': 'True'}),
            'borrower_id_number': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'borrower_name': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'borrower_phone': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            ...
            'soldout_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "u'\\u5f85\\u5ba1\\u6838'", 'max_length': '16'}),
