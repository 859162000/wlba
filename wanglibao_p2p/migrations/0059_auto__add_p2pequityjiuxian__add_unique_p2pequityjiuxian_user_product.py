...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'P2PEquityJiuxian'
        db.create_table(u'wanglibao_p2p_p2pequityjiuxian', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='equity_jiuxian_user', to=orm['auth.User'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='equity_jiuxian_p2p', to=orm['wanglibao_p2p.P2PProduct'])),
            ('equity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='equity_jiuxian', to=orm['wanglibao_p2p.P2PEquity'])),
            ('equity_amount', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ...
            ('selected_type', self.gf('django.db.models.fields.CharField')(default='principal', max_length=20)),
        ...
        db.send_create_signal(u'wanglibao_p2p', ['P2PEquityJiuxian'])

        # Adding unique constraint on 'P2PEquityJiuxian', fields ['user', 'product']
        db.create_unique(u'wanglibao_p2p_p2pequityjiuxian', ['user_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'P2PEquityJiuxian', fields ['user', 'product']
        db.delete_unique(u'wanglibao_p2p_p2pequityjiuxian', ['user_id', 'product_id'])

        # Deleting model 'P2PEquityJiuxian'
        db.delete_table(u'wanglibao_p2p_p2pequityjiuxian')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 5, 0, 0)'}),
