...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContractTemplate.content_preview'
        db.add_column(u'wanglibao_p2p_contracttemplate', 'content_preview',
        ...
        db.add_column(u'wanglibao_p2p_contracttemplate', 'available_bank',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContractTemplate.content_preview'
        db.delete_column(u'wanglibao_p2p_contracttemplate', 'content_preview')
    ...
    models = {
        ...
        u'wanglibao_p2p.contracttemplate': {
            ...
            'available_bank': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1128'}),
            ...
            'party_c_addr': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128'}),
