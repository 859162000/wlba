...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductPaymentHistory'
        db.create_table(u'wanglibao_p2p_productpaymenthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace='')),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments', null=True, to=orm['wanglibao_p2p.P2PProduct'])),
            ('term', self.gf('django.db.models.fields.IntegerField')()),
            ('term_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal(u'wanglibao_p2p', ['ProductPaymentHistory'])

        # Adding model 'UserPaymentHistory'
        db.create_table(u'wanglibao_p2p_userpaymenthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('concurrency.fields.IntegerVersionField')(name='version', db_tablespace='')),
            ('product_payment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subs', to=orm['wanglibao_p2p.ProductPaymentHistory'])),
        ...
        db.send_create_signal(u'wanglibao_p2p', ['UserPaymentHistory'])


    def backwards(self, orm):
        # Deleting model 'ProductPaymentHistory'
        db.delete_table(u'wanglibao_p2p_productpaymenthistory')

        # Deleting model 'UserPaymentHistory'
        db.delete_table(u'wanglibao_p2p_userpaymenthistory')
    ...
    models = {
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 15, 0, 0)'}),
        ...
        u'wanglibao_p2p.productpaymenthistory': {
            'Meta': {'ordering': "['term']", 'object_name': 'ProductPaymentHistory'},
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'penal_interest': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '20', 'decimal_places': '2'}),
            'principal': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments'", 'null': 'True', 'to': u"orm['wanglibao_p2p.P2PProduct']"}),
            'term': ('django.db.models.fields.IntegerField', [], {}),
            'term_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'version': ('concurrency.fields.IntegerVersionField', [], {'name': "'version'", 'db_tablespace': "''"})
        },
        ...
        u'wanglibao_p2p.userpaymenthistory': {
            'Meta': {'ordering': "['user', 'term']", 'object_name': 'UserPaymentHistory'},
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'penal_interest': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            'principal': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'product_payment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subs'", 'to': u"orm['wanglibao_p2p.ProductPaymentHistory']"}),
            'term': ('django.db.models.fields.IntegerField', [], {}),
            'term_date': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'version': ('concurrency.fields.IntegerVersionField', [], {'name': "'version'", 'db_tablespace': "''"})
