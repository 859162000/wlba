...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InterestPrecisionBalance'
        db.create_table(u'wanglibao_p2p_interestprecisionbalance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('equity', self.gf('django.db.models.fields.related.OneToOneField')(related_name='interest_precision_balance', unique=True, null=True, to=orm['wanglibao_p2p.P2PEquity'])),
            ('principal', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('interest_receivable', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('interest_actual', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8)),
            ('interest_precision_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=8)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_p2p', ['InterestPrecisionBalance'])


    def backwards(self, orm):
        # Deleting model 'InterestPrecisionBalance'
        db.delete_table(u'wanglibao_p2p_interestprecisionbalance')
    ...
    models = {
        ...
        u'wanglibao_p2p.interestprecisionbalance': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'equity': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'interest_precision_balance'", 'unique': 'True', 'null': 'True', 'to': u"orm['wanglibao_p2p.P2PEquity']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest_actual': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '8'}),
            'interest_precision_balance': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '8'}),
            'interest_receivable': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'principal': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'})
        },
