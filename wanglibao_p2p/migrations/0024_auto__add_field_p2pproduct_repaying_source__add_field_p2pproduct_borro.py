...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PProduct.repaying_source'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'repaying_source',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'P2PProduct.borrower_address'
        db.add_column(u'wanglibao_p2p_p2pproduct', 'borrower_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'P2PEquity.confirm_at'
        db.add_column(u'wanglibao_p2p_p2pequity', 'confirm_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PProduct.repaying_source'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'repaying_source')

        # Deleting field 'P2PProduct.borrower_address'
        db.delete_column(u'wanglibao_p2p_p2pproduct', 'borrower_address')

        # Deleting field 'P2PEquity.confirm_at'
        db.delete_column(u'wanglibao_p2p_p2pequity', 'confirm_at')
