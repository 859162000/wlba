...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductAmortization.term_date'
        db.alter_column(u'wanglibao_p2p_productamortization', 'term_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductAmortization.term_date'
        db.alter_column(u'wanglibao_p2p_productamortization', 'term_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 15, 0, 0)))
    ...
    models = {
        ...
        u'wanglibao_p2p.productamortization': {
            ...
            'term': ('django.db.models.fields.IntegerField', [], {}),
            'term_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'})
        },
