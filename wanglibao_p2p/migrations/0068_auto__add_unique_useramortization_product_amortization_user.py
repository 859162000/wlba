...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserAmortization', fields ['product_amortization', 'user']
        db.create_unique(u'wanglibao_p2p_useramortization', ['product_amortization_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserAmortization', fields ['product_amortization', 'user']
        db.delete_unique(u'wanglibao_p2p_useramortization', ['product_amortization_id', 'user_id'])
    ...
    models = {
        ...
        u'wanglibao_p2p.automaticmanager': {
            ...
            'last_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 4, 22, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'wanglibao_p2p.useramortization': {
            'Meta': {'ordering': "['user', 'term']", 'unique_together': "(('product_amortization', 'user'),)", 'object_name': 'UserAmortization'},
            'coupon_interest': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
