...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserEquity', fields ['user', 'product']
        db.create_unique(u'wanglibao_p2p_userequity', ['user_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserEquity', fields ['user', 'product']
        db.delete_unique(u'wanglibao_p2p_userequity', ['user_id', 'product_id'])
