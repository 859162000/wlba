...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attachment.extra_data'
        db.delete_column(u'wanglibao_p2p_attachment', 'extra_data')


    def backwards(self, orm):
        # Adding field 'Attachment.extra_data'
        db.add_column(u'wanglibao_p2p_attachment', 'extra_data',
