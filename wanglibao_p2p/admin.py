...
class P2PProductAdmin(ReadPermissionModelAdmin, ImportExportModelAdmin, ConcurrentModelAdmin, VersionAdmin):
    ...
    list_display = ('id', 'name', 'total_amount', 'types', 'brief', 'status', 'pay_method', 'period', 'end_time',
                    'warrant_company', 'audit_link', 'preview_link', 'preview_contract', 'copy_link', 'priority')
    list_editable = ('priority',)
    list_filter = ('status', 'types', 'period')
    search_fields = ('name', 'serial_number', 'contract_serial_number', 'brief', 'warrant_company__name')
