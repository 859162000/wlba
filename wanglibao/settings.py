...
DEFAULT_INVALID_TOKEN = 'default_4a8ae7df41203d14580c744b08933498'
...
if ENV == ENV_PRODUCTION:
    BAJINSHE_ACCESS_TOKEN_URL = 'http://api2.bajinshe.com/bjsv2/json/v1/external/TokenService/getAccessToken/gzip'
    BAJINSHE_PRODUCT_PUSH_URL = 'http://api2.bajinshe.com/bjsv2/json/v1/external/ProductService/publishProduct/gzip'
    BAJINSHE_ACCOUNT_PUSH_URL = 'http://api2.bajinshe.com/bjsv2/json/v1/external/AccountService/pushAccount/gzip'
    BAJINSHE_TRANSACTION_PUSH_URL = 'http://api2.bajinshe.com/bjsv2/json/v1/external/BusinessLogService/pushBusinessLog/gzip'
    BAJINSHE_PURCHASE_PUSH_URL = 'http://api2.bajinshe.com/bjsv2/json/v1/external/InvestmentService/pushInvestment/gzip'
elif ENV == ENV_ALPHA:
...
if ENV == ENV_PRODUCTION:
    ...
    BISOUYI_PRODUCT_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/product/basice'
    BISOUYI_PRODUCT_STATUS_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/product/status'
    BISOUYI_INTEREST_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/account/money'
    BISOUYI_PURCHASE_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/purchase'
    BISOUYI_PURCHASE_STATUS_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/purchaseStauts'
    BISOUYI_WITHDRAW_RECHARGE_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/ransom'
    BISOUYI_WITHDRAW_STATUS_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/ransomStatus'
    BISOUYI_BIND_CARD_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/account/opened'
    BISOUYI_OATUH_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/account/oauth'
    BISOUYI_ORDER_RELATION_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/purchaseRelation'
    BISOUYI_ON_INTEREST_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/purchaseIncome'
    BISOUYI_PURCHASE_REFUND_PUSH_URL = 'http://app.bisouyi.com:8082/bsy-pop-web/openapi/p2p/trading/purchaseRefund'
else:
    BISOUYI_PCODE = '10002'
