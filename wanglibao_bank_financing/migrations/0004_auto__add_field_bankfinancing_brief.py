...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BankFinancing.brief'
        db.add_column(u'wanglibao_bank_financing_bankfinancing', 'brief',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BankFinancing.brief'
        db.delete_column(u'wanglibao_bank_financing_bankfinancing', 'brief')
