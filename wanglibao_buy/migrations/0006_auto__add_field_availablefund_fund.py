...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AvailableFund.fund'
        db.add_column(u'wanglibao_buy_availablefund', 'fund',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['wanglibao_fund.Fund'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AvailableFund.fund'
        db.delete_column(u'wanglibao_buy_availablefund', 'fund_id')
