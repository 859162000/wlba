...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AvailableFund.last_update'
        db.alter_column(u'wanglibao_buy_availablefund', 'last_update', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'TradeHistory.create_date'
        db.alter_column(u'wanglibao_buy_tradehistory', 'create_date', self.gf('django.db.models.fields.DateField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'AvailableFund.last_update'
        db.alter_column(u'wanglibao_buy_availablefund', 'last_update', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'TradeHistory.create_date'
        db.alter_column(u'wanglibao_buy_tradehistory', 'create_date', self.gf('django.db.models.fields.DateField')())
