...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DailyIncome.count'
        db.add_column(u'wanglibao_buy_dailyincome', 'count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'DailyIncome.date'
        db.alter_column(u'wanglibao_buy_dailyincome', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'DailyIncome.count'
        db.delete_column(u'wanglibao_buy_dailyincome', 'count')


        # Changing field 'DailyIncome.date'
        db.alter_column(u'wanglibao_buy_dailyincome', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
