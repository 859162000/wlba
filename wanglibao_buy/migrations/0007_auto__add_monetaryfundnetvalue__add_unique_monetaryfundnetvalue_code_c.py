...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MonetaryFundNetValue'
        db.create_table(u'wanglibao_buy_monetaryfundnetvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('curr_date', self.gf('django.db.models.fields.DateField')()),
            ('income_per_ten_thousand', self.gf('django.db.models.fields.FloatField')()),
            ('create_date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_buy', ['MonetaryFundNetValue'])

        # Adding unique constraint on 'MonetaryFundNetValue', fields ['code', 'curr_date']
        db.create_unique(u'wanglibao_buy_monetaryfundnetvalue', ['code', 'curr_date'])

        # Adding model 'DailyIncome'
        ...
        # Adding unique constraint on 'DailyIncome', fields ['user', 'date']
        db.create_unique(u'wanglibao_buy_dailyincome', ['user_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'DailyIncome', fields ['user', 'date']
        db.delete_unique(u'wanglibao_buy_dailyincome', ['user_id', 'date'])

        # Removing unique constraint on 'MonetaryFundNetValue', fields ['code', 'curr_date']
        db.delete_unique(u'wanglibao_buy_monetaryfundnetvalue', ['code', 'curr_date'])

        # Deleting model 'MonetaryFundNetValue'
        db.delete_table(u'wanglibao_buy_monetaryfundnetvalue')

        # Deleting model 'DailyIncome'
        db.delete_table(u'wanglibao_buy_dailyincome')
    ...
    models = {
        ...
        u'wanglibao_buy.monetaryfundnetvalue': {
            'Meta': {'ordering': "['-create_date']", 'unique_together': "(('code', 'curr_date'),)", 'object_name': 'MonetaryFundNetValue'},
