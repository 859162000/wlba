...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'wanglibao_oauth2.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'e4e552bff7bea3f3ab19949223490a45d5c5df79'", 'max_length': '255', 'db_index': 'True'}),
        ...
        u'wanglibao_oauth2.client': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'aab342e00d840649c840'", 'unique': 'True', 'max_length': '255'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'8660720fd91e3935c0ee206c4cf43acabfbe5bb4'", 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'wanglibao_oauth2.refreshtoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'e018da7a3209d3f458e119c8216bc6aa3f5a9596'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
