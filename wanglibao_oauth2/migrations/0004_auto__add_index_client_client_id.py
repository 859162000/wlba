...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Client', fields ['client_id']
        db.create_index(u'wanglibao_oauth2_client', ['client_id'])


    def backwards(self, orm):
        # Removing index on 'Client', fields ['client_id']
        db.delete_index(u'wanglibao_oauth2_client', ['client_id'])
    ...
    models = {
        ...
        u'wanglibao_oauth2.accesstoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'75943499535da31c205566fab787ef07504e26d5'", 'max_length': '255', 'db_index': 'True'}),
        ...
        u'wanglibao_oauth2.client': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'daa6e881ff112d7b0488'", 'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': "'05a99d2152368c41534424748799be4b50be504f'", 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'wanglibao_oauth2.refreshtoken': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'b5472d21696df84c5fc91f03e25b9384b1272b6a'", 'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
    }
