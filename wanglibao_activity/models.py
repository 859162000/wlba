...
class Activity(models.Model):
    ...
    code = models.CharField(u'活动代码（字母/数字组合）*', max_length=16, unique=True)
...
class ActivityRule(models.Model):
    ...
    income = models.FloatField(u'收益或收益率（送收益时填写）', default=10, help_text=u'固定金额时填写大于1的数字，收益率时填写0-1之间的小数')
