...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRecord.income'
        db.add_column(u'wanglibao_activity_activityrecord', 'income',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRecord.income'
        db.delete_column(u'wanglibao_activity_activityrecord', 'income')
