...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.p2p_types'
        db.add_column(u'wanglibao_activity_activityrule', 'p2p_types',
        ...
        # Adding field 'ActivityRule.period'
        db.add_column(u'wanglibao_activity_activityrule', 'period',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'ActivityRule.period_type'
        db.add_column(u'wanglibao_activity_activityrule', 'period_type',
                      self.gf('django.db.models.fields.CharField')(default='month', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.p2p_types'
        db.delete_column(u'wanglibao_activity_activityrule', 'p2p_types_id')

        # Deleting field 'ActivityRule.period'
        db.delete_column(u'wanglibao_activity_activityrule', 'period')

        # Deleting field 'ActivityRule.period_type'
        db.delete_column(u'wanglibao_activity_activityrule', 'period_type')
