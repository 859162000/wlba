...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityBannerShow'
        db.create_table(u'wanglibao_activity_activitybannershow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity_show', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_activity.ActivityShow'])),
            ('banner_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('show_start_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('show_end_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_activity', ['ActivityBannerShow'])

        # Adding field 'ActivityShow.main_banner'
        db.add_column(u'wanglibao_activity_activityshow', 'main_banner',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityShow.left_banner'
        db.add_column(u'wanglibao_activity_activityshow', 'left_banner',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityShow.right_banner'
        db.add_column(u'wanglibao_activity_activityshow', 'right_banner',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ActivityBannerShow'
        db.delete_table(u'wanglibao_activity_activitybannershow')

        # Deleting field 'ActivityShow.main_banner'
        db.delete_column(u'wanglibao_activity_activityshow', 'main_banner')

        # Deleting field 'ActivityShow.left_banner'
        db.delete_column(u'wanglibao_activity_activityshow', 'left_banner')

        # Deleting field 'ActivityShow.right_banner'
        db.delete_column(u'wanglibao_activity_activityshow', 'right_banner')
    ...
    models = {
        ...
        u'wanglibao_activity.activitybannershow': {
            'Meta': {'ordering': "['show_start_at']", 'object_name': 'ActivityBannerShow'},
            'activity_show': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wanglibao_activity.ActivityShow']"}),
            'banner_type': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'show_start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'})
        },
