...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityBannerPosition'
        db.create_table(u'wanglibao_activity_activitybannerposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('main', self.gf('django.db.models.fields.related.ForeignKey')(related_name='act_banner_main', to=orm['wanglibao_activity.ActivityShow'])),
            ('main_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('second_left', self.gf('django.db.models.fields.related.ForeignKey')(related_name='act_banner_left', to=orm['wanglibao_activity.ActivityShow'])),
            ('left_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('second_right', self.gf('django.db.models.fields.related.ForeignKey')(related_name='act_banner_right', to=orm['wanglibao_activity.ActivityShow'])),
            ('right_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal(u'wanglibao_activity', ['ActivityBannerPosition'])

        # Deleting field 'ActivityShow.banner_pos'
        db.delete_column(u'wanglibao_activity_activityshow', 'banner_pos')

        # Deleting field 'ActivityShow.pc_banner'
        db.delete_column(u'wanglibao_activity_activityshow', 'pc_banner')


    def backwards(self, orm):
        # Deleting model 'ActivityBannerPosition'
        db.delete_table(u'wanglibao_activity_activitybannerposition')

        # Adding field 'ActivityShow.banner_pos'
        db.add_column(u'wanglibao_activity_activityshow', 'banner_pos',
                      self.gf('django.db.models.fields.CharField')(default=u'\u4e3b\u63a8', max_length=20),
                      keep_default=False)

        # Adding field 'ActivityShow.pc_banner'
        db.add_column(u'wanglibao_activity_activityshow', 'pc_banner',
    ...
    models = {
        ...
        u'wanglibao_activity.activitybannerposition': {
            'Meta': {'object_name': 'ActivityBannerPosition'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'wanglibao_activity.activityshow': {
            ...
            'app_detail_link': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'app_template': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'pc_detail_link': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'pc_template': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
