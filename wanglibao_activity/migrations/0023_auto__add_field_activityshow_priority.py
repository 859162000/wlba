...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityShow.priority'
        db.add_column(u'wanglibao_activity_activityshow', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityShow.priority'
        db.delete_column(u'wanglibao_activity_activityshow', 'priority')
