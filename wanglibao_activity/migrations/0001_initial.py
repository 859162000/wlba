...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wanglibao_activity_activity', (
            ...
            ('product_ids', self.gf('django.db.models.fields.CharField')(default=0, max_length=20, blank=True)),
            ...
            ('stop_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default=u'\u672a\u5f00\u59cb', max_length=20)),
        ...
        db.create_table(u'wanglibao_activity_activityrule', (
            ...
            ('redpack', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_redpack.RedPackEvent'], blank=True)),
            ('reward', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('income', self.gf('django.db.models.fields.FloatField')(default=10)),
    ...
    models = {
        ...
        u'wanglibao_activity.activity': {
            ...
            'product_ids': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '20', 'blank': 'True'}),
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "u'\\u672a\\u5f00\\u59cb'", 'max_length': '20'}),
            'stop_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'wanglibao_activity.activityrule': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income': ('django.db.models.fields.FloatField', [], {'default': '10'}),
            ...
            'redpack': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wanglibao_redpack.RedPackEvent']", 'blank': 'True'}),
