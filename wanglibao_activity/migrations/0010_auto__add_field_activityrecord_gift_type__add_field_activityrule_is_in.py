...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRecord.gift_type'
        db.add_column(u'wanglibao_activity_activityrecord', 'gift_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'ActivityRule.is_in_date'
        db.add_column(u'wanglibao_activity_activityrule', 'is_in_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActivityRule.is_invite_in_date'
        db.add_column(u'wanglibao_activity_activityrule', 'is_invite_in_date',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRecord.gift_type'
        db.delete_column(u'wanglibao_activity_activityrecord', 'gift_type')

        # Deleting field 'ActivityRule.is_in_date'
        db.delete_column(u'wanglibao_activity_activityrule', 'is_in_date')

        # Deleting field 'ActivityRule.is_invite_in_date'
        db.delete_column(u'wanglibao_activity_activityrule', 'is_invite_in_date')
