...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityTemplates.login_invite'
        db.add_column(u'wanglibao_activity_activitytemplates', 'login_invite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActivityTemplates.is_login_href'
        db.add_column(u'wanglibao_activity_activitytemplates', 'is_login_href',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActivityTemplates.login_href_desc'
        db.add_column(u'wanglibao_activity_activitytemplates', 'login_href_desc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'ActivityTemplates.login_href'
        db.add_column(u'wanglibao_activity_activitytemplates', 'login_href',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'ActivityTemplates.rule_use_name'
        db.add_column(u'wanglibao_activity_activitytemplates', 'rule_use_name',
                      self.gf('django.db.models.fields.CharField')(max_length='128', null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityTemplates.rule_activity_name'
        db.add_column(u'wanglibao_activity_activitytemplates', 'rule_activity_name',
                      self.gf('django.db.models.fields.CharField')(max_length='128', null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityTemplates.rule_reward_name'
        db.add_column(u'wanglibao_activity_activitytemplates', 'rule_reward_name',
                      self.gf('django.db.models.fields.CharField')(max_length='128', null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityTemplates.is_diy'
        db.add_column(u'wanglibao_activity_activitytemplates', 'is_diy',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActivityTemplates.diy_img'
        db.add_column(u'wanglibao_activity_activitytemplates', 'diy_img',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActivityTemplates.diy_location'
        db.add_column(u'wanglibao_activity_activitytemplates', 'diy_location',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityTemplates.login_invite'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'login_invite')

        # Deleting field 'ActivityTemplates.is_login_href'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'is_login_href')

        # Deleting field 'ActivityTemplates.login_href_desc'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'login_href_desc')

        # Deleting field 'ActivityTemplates.login_href'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'login_href')

        # Deleting field 'ActivityTemplates.rule_use_name'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'rule_use_name')

        # Deleting field 'ActivityTemplates.rule_activity_name'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'rule_activity_name')

        # Deleting field 'ActivityTemplates.rule_reward_name'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'rule_reward_name')

        # Deleting field 'ActivityTemplates.is_diy'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'is_diy')

        # Deleting field 'ActivityTemplates.diy_img'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'diy_img')

        # Deleting field 'ActivityTemplates.diy_location'
        db.delete_column(u'wanglibao_activity_activitytemplates', 'diy_location')
