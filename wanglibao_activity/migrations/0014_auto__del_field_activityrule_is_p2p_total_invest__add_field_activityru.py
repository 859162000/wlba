...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActivityRule.is_p2p_total_invest'
        db.delete_column(u'wanglibao_activity_activityrule', 'is_p2p_total_invest')

        # Adding field 'ActivityRule.total_invest_order'
        db.add_column(u'wanglibao_activity_activityrule', 'total_invest_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


        # Changing field 'Activity.code'
        db.alter_column(u'wanglibao_activity_activity', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64))

        # Changing field 'Activity.product_ids'
        db.alter_column(u'wanglibao_activity_activity', 'product_ids', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    def backwards(self, orm):
        # Adding field 'ActivityRule.is_p2p_total_invest'
        db.add_column(u'wanglibao_activity_activityrule', 'is_p2p_total_invest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ActivityRule.total_invest_order'
        db.delete_column(u'wanglibao_activity_activityrule', 'total_invest_order')


        # Changing field 'Activity.code'
        db.alter_column(u'wanglibao_activity_activity', 'code', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True))

        # Changing field 'Activity.product_ids'
        db.alter_column(u'wanglibao_activity_activity', 'product_ids', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Activity.channel'
        db.alter_column(u'wanglibao_activity_activity', 'channel', self.gf('django.db.models.fields.CharField')(max_length=20))
