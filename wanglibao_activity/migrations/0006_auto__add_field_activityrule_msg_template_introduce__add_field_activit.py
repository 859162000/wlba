...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.msg_template_introduce'
        db.add_column(u'wanglibao_activity_activityrule', 'msg_template_introduce',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ActivityRule.sms_template_introduce'
        db.add_column(u'wanglibao_activity_activityrule', 'sms_template_introduce',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.msg_template_introduce'
        db.delete_column(u'wanglibao_activity_activityrule', 'msg_template_introduce')

        # Deleting field 'ActivityRule.sms_template_introduce'
        db.delete_column(u'wanglibao_activity_activityrule', 'sms_template_introduce')
