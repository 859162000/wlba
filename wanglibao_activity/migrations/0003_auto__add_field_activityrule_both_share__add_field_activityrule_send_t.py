...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.both_share'
        db.add_column(u'wanglibao_activity_activityrule', 'both_share',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ActivityRule.send_type'
        db.add_column(u'wanglibao_activity_activityrule', 'send_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u7cfb\u7edf\u5b9e\u65f6\u53d1\u653e', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.both_share'
        db.delete_column(u'wanglibao_activity_activityrule', 'both_share')

        # Deleting field 'ActivityRule.send_type'
        db.delete_column(u'wanglibao_activity_activityrule', 'send_type')
