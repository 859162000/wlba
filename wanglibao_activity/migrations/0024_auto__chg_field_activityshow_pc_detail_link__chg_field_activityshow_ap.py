...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityShow.pc_detail_link'
        db.alter_column(u'wanglibao_activity_activityshow', 'pc_detail_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ActivityShow.app_detail_link'
        db.alter_column(u'wanglibao_activity_activityshow', 'app_detail_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ActivityShow.pc_template'
        db.alter_column(u'wanglibao_activity_activityshow', 'pc_template', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'ActivityShow.app_template'
        db.alter_column(u'wanglibao_activity_activityshow', 'app_template', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ActivityShow.pc_detail_link'
        db.alter_column(u'wanglibao_activity_activityshow', 'pc_detail_link', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ActivityShow.app_detail_link'
        db.alter_column(u'wanglibao_activity_activityshow', 'app_detail_link', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ActivityShow.pc_template'
        db.alter_column(u'wanglibao_activity_activityshow', 'pc_template', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'ActivityShow.app_template'
        db.alter_column(u'wanglibao_activity_activityshow', 'app_template', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
