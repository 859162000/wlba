...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityRule.redpack'
        db.alter_column(u'wanglibao_activity_activityrule', 'redpack', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'ActivityRule.reward'
        db.alter_column(u'wanglibao_activity_activityrule', 'reward', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'ActivityRule.redpack'
        db.alter_column(u'wanglibao_activity_activityrule', 'redpack', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'ActivityRule.reward'
        db.alter_column(u'wanglibao_activity_activityrule', 'reward', self.gf('django.db.models.fields.CharField')(max_length=60))
