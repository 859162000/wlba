...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.is_total_invest'
        db.add_column(u'wanglibao_activity_activityrule', 'is_total_invest',
        ...
        # Adding field 'ActivityRule.ranking'
        db.add_column(u'wanglibao_activity_activityrule', 'ranking',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.is_total_invest'
        db.delete_column(u'wanglibao_activity_activityrule', 'is_total_invest')

        # Deleting field 'ActivityRule.is_p2p_total_invest'
        db.delete_column(u'wanglibao_activity_activityrule', 'is_p2p_total_invest')

        # Deleting field 'ActivityRule.ranking'
        db.delete_column(u'wanglibao_activity_activityrule', 'ranking')
    ...
    models = {
        ...
        u'wanglibao_activity.activityrule': {
            ...
            'is_p2p_total_invest': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
