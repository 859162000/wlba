...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WapActivityTemplates'
        db.create_table(u'wanglibao_activity_wapactivitytemplates', (
            ...
            ('aim_template', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('is_rendering', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('func_rendering', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
        ...
        db.send_create_signal(u'wanglibao_activity', ['WapActivityTemplates'])


    def backwards(self, orm):
        # Deleting model 'WapActivityTemplates'
        db.delete_table(u'wanglibao_activity_wapactivitytemplates')
