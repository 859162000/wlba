...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.wx_template'
        db.add_column(u'wanglibao_activity_activityrule', 'wx_template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.wx_template'
        db.delete_column(u'wanglibao_activity_activityrule', 'wx_template')
