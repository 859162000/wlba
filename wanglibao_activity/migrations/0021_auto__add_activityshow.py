...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityShow'
        db.create_table(u'wanglibao_activity_activityshow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_activity.Activity'])),
            ('category', self.gf('django.db.models.fields.CharField')(default=u'\u5168\u90e8', max_length=20)),
            ('is_pc', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('banner_pos', self.gf('django.db.models.fields.CharField')(default=u'\u4e3b\u63a8', max_length=20)),
            ('pc_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('pc_detail_link', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pc_template', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('pc_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_app', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('app_banner', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('app_detail_link', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('app_template', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('link_is_hide', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'wanglibao_activity', ['ActivityShow'])


    def backwards(self, orm):
        # Deleting model 'ActivityShow'
        db.delete_table(u'wanglibao_activity_activityshow')
    ...
    models = {
        ...
        u'wanglibao_activity.activityshow': {
            ...
            'banner_pos': ('django.db.models.fields.CharField', [], {'default': "u'\\u4e3b\\u63a8'", 'max_length': '20'}),
            ...
            'pc_banner': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
