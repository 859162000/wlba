...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ActivityRecord', fields ['created_at']
        db.create_index(u'wanglibao_activity_activityrecord', ['created_at'])


    def backwards(self, orm):
        # Removing index on 'ActivityRecord', fields ['created_at']
        db.delete_index(u'wanglibao_activity_activityrecord', ['created_at'])
