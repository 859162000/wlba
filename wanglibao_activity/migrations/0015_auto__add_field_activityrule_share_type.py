...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.share_type'
        db.add_column(u'wanglibao_activity_activityrule', 'share_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.share_type'
        db.delete_column(u'wanglibao_activity_activityrule', 'share_type')
    ...
    models = {
        ...
        u'wanglibao_activity.activityrule': {
            ...
            'share_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
