...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRecord.send_type'
        db.add_column(u'wanglibao_activity_activityrecord', 'send_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u7cfb\u7edf', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRecord.send_type'
        db.delete_column(u'wanglibao_activity_activityrecord', 'send_type')
