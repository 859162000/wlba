...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRule.is_used'
        db.add_column(u'wanglibao_activity_activityrule', 'is_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRule.is_used'
        db.delete_column(u'wanglibao_activity_activityrule', 'is_used')
