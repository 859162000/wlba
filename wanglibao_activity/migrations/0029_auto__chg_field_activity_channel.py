...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'wanglibao_activity_activity', 'channel', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Activity.channel'
        db.alter_column(u'wanglibao_activity_activity', 'channel', self.gf('django.db.models.fields.CharField')(max_length=800))
