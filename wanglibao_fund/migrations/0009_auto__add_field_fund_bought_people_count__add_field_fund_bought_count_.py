...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fund.bought_people_count'
        db.add_column(u'wanglibao_fund_fund', 'bought_people_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Fund.bought_count'
        db.add_column(u'wanglibao_fund_fund', 'bought_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Fund.bought_amount'
        db.add_column(u'wanglibao_fund_fund', 'bought_amount',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Fund.investment_threshold'
        db.add_column(u'wanglibao_fund_fund', 'investment_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fund.bought_people_count'
        db.delete_column(u'wanglibao_fund_fund', 'bought_people_count')

        # Deleting field 'Fund.bought_count'
        db.delete_column(u'wanglibao_fund_fund', 'bought_count')

        # Deleting field 'Fund.bought_amount'
        db.delete_column(u'wanglibao_fund_fund', 'bought_amount')

        # Deleting field 'Fund.investment_threshold'
        db.delete_column(u'wanglibao_fund_fund', 'investment_threshold')
