...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fund.bought_count_random'
        db.add_column(u'wanglibao_fund_fund', 'bought_count_random',
                      self.gf('django.db.models.fields.FloatField')(default=1.11),
                      keep_default=False)

        # Adding field 'Fund.bought_amount_random'
        db.add_column(u'wanglibao_fund_fund', 'bought_amount_random',
                      self.gf('django.db.models.fields.FloatField')(default=1.3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fund.bought_count_random'
        db.delete_column(u'wanglibao_fund_fund', 'bought_count_random')

        # Deleting field 'Fund.bought_amount_random'
        db.delete_column(u'wanglibao_fund_fund', 'bought_amount_random')
    ...
    models = {
        u'wanglibao_fund.fund': {
            ...
            'bought_amount_random': ('django.db.models.fields.FloatField', [], {'default': '1.3'}),
            'bought_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'bought_count_random': ('django.db.models.fields.FloatField', [], {'default': '1.11'}),
