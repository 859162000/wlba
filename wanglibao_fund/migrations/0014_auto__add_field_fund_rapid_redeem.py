...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fund.rapid_redeem'
        db.add_column(u'wanglibao_fund_fund', 'rapid_redeem',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fund.rapid_redeem'
        db.delete_column(u'wanglibao_fund_fund', 'rapid_redeem')
