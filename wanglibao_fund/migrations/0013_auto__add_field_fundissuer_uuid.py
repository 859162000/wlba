...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FundIssuer.uuid'
        db.add_column(u'wanglibao_fund_fundissuer', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FundIssuer.uuid'
        db.delete_column(u'wanglibao_fund_fundissuer', 'uuid')
    ...
    models = {
        u'wanglibao_fund.fund': {
            ...
            'bought_amount_random': ('django.db.models.fields.FloatField', [], {'default': '1.03'}),
