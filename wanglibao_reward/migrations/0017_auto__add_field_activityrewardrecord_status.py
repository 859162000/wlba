...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRewardRecord.status'
        db.add_column(u'wanglibao_reward_activityrewardrecord', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityRewardRecord.status'
        db.delete_column(u'wanglibao_reward_activityrewardrecord', 'status')
