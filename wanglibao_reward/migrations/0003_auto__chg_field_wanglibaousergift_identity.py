...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WanglibaoUserGift.identity'
        db.alter_column(u'wanglibao_reward_wanglibaousergift', 'identity', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'WanglibaoUserGift.identity'
        db.alter_column(u'wanglibao_reward_wanglibaousergift', 'identity', self.gf('django.db.models.fields.IntegerField')())
