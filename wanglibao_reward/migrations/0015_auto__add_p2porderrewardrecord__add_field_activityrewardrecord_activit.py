...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'P2pOrderRewardRecord'
        db.create_table(u'wanglibao_reward_p2porderrewardrecord', (
            ...
            ('redpack_event_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('redpack_record_id', self.gf('django.db.models.fields.IntegerField')(default=0, null=True)),
            ('status', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('activity_desc', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'wanglibao_reward', ['P2pOrderRewardRecord'])

        # Adding field 'ActivityRewardRecord.activity_desc'
        db.add_column(u'wanglibao_reward_activityrewardrecord', 'activity_desc',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'P2pOrderRewardRecord'
        db.delete_table(u'wanglibao_reward_p2porderrewardrecord')

        # Deleting field 'ActivityRewardRecord.activity_desc'
        db.delete_column(u'wanglibao_reward_activityrewardrecord', 'activity_desc')
