...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WanglibaoActivityRewardOrder'
        db.create_table(u'wanglibao_reward_wanglibaoactivityrewardorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order_id', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reward_owner_order', on_delete=models.SET_NULL, default=None, to=orm['auth.User'], blank=True, null=True)),
            ('redpack_event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_redpack.RedPackEvent'], null=True, blank=True)),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['marketing.Reward'], null=True, blank=True)),
            ('experience', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['experience_gold.ExperienceEvent'], null=True, blank=True)),
            ('activity', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('qrcode', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('when_dist', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('left_times', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('join_times', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('channel', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
            ('has_sent', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('p2p_amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'wanglibao_reward', ['WanglibaoActivityRewardOrder'])

        # Adding index on 'WanglibaoActivityRewardOrder', fields ['user', 'activity']
        db.create_index(u'wanglibao_reward_wanglibaoactivityrewardorder', ['user_id', 'activity'])


    def backwards(self, orm):
        # Removing index on 'WanglibaoActivityRewardOrder', fields ['user', 'activity']
        db.delete_index(u'wanglibao_reward_wanglibaoactivityrewardorder', ['user_id', 'activity'])

        # Deleting model 'WanglibaoActivityRewardOrder'
        db.delete_table(u'wanglibao_reward_wanglibaoactivityrewardorder')
    ...
    models = {
        ...
        u'marketing.reward': {
            'Meta': {'ordering': "['-create_time']", 'object_name': 'Reward', 'index_together': "(('type', 'is_used'),)"},
        ...
        u'wanglibao_activity.activity': {
            ...
            'channel': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'blank': 'True'}),
        ...
        u'wanglibao_p2p.producttype': {
            ...
            'fiance_type': ('django.db.models.fields.CharField', [], {'default': "u'\\u4ea7\\u878d\\u901a'", 'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'wanglibao_redpack.redpackevent': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'p2p_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        u'wanglibao_reward.wanglibaoactivityrewardorder': {
            'Meta': {'object_name': 'WanglibaoActivityRewardOrder', 'index_together': "(('user', 'activity'),)"},
            'activity': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
            'channel': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'}),
            'create_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'experience': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['experience_gold.ExperienceEvent']", 'null': 'True', 'blank': 'True'}),
            ...
            'reward': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['marketing.Reward']", 'null': 'True', 'blank': 'True'}),
            'update_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reward_owner_order'", 'on_delete': 'models.SET_NULL', 'default': 'None', 'to': u"orm['auth.User']", 'blank': 'True', 'null': 'True'}),
            'when_dist': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
