...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ActivityRewardRecord', fields ['user', 'create_date', 'activity_code']
        db.create_unique(u'wanglibao_reward_activityrewardrecord', ['user_id', 'create_date', 'activity_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActivityRewardRecord', fields ['user', 'create_date', 'activity_code']
        db.delete_unique(u'wanglibao_reward_activityrewardrecord', ['user_id', 'create_date', 'activity_code'])
