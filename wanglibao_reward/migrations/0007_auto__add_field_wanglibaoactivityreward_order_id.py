...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoActivityReward.order_id'
        db.add_column(u'wanglibao_reward_wanglibaoactivityreward', 'order_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoActivityReward.order_id'
        db.delete_column(u'wanglibao_reward_wanglibaoactivityreward', 'order_id')
