...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoActivityReward.experience'
        db.add_column(u'wanglibao_reward_wanglibaoactivityreward', 'experience',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['experience_gold.ExperienceEvent'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoActivityReward.experience'
        db.delete_column(u'wanglibao_reward_wanglibaoactivityreward', 'experience_id')
