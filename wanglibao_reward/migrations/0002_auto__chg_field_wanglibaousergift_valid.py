...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WanglibaoUserGift.valid'
        db.alter_column(u'wanglibao_reward_wanglibaousergift', 'valid', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'WanglibaoUserGift.valid'
        db.alter_column(u'wanglibao_reward_wanglibaousergift', 'valid', self.gf('django.db.models.fields.BooleanField')())
