...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WanglibaoActivityReward.reward'
        db.alter_column(u'wanglibao_reward_wanglibaoactivityreward', 'reward_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.Reward'], null=True))

        # Changing field 'WanglibaoActivityReward.redpack_event'
        db.alter_column(u'wanglibao_reward_wanglibaoactivityreward', 'redpack_event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_redpack.RedPackEvent'], null=True))

    def backwards(self, orm):

        # Changing field 'WanglibaoActivityReward.reward'
        db.alter_column(u'wanglibao_reward_wanglibaoactivityreward', 'reward_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['marketing.Reward']))

        # Changing field 'WanglibaoActivityReward.redpack_event'
        db.alter_column(u'wanglibao_reward_wanglibaoactivityreward', 'redpack_event_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_redpack.RedPackEvent']))
