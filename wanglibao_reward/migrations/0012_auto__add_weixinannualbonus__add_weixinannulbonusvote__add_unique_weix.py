...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeixinAnnualBonus'
        db.create_table(u'wanglibao_reward_weixinannualbonus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('openid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('nickname', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('headimgurl', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ...
            ('is_max', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_pay', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('min_annual_bonus', self.gf('django.db.models.fields.IntegerField')(default=1000)),
            ('max_annual_bonus', self.gf('django.db.models.fields.IntegerField')(default=1000)),
            ('annual_bonus', self.gf('django.db.models.fields.IntegerField')(default=1000)),
            ('good_vote', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bad_vote', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('share_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('visit_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('visit_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('pay_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'wanglibao_reward', ['WeixinAnnualBonus'])

        # Adding model 'WeixinAnnulBonusVote'
        db.create_table(u'wanglibao_reward_weixinannulbonusvote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('to_openid', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('from_openid', self.gf('django.db.models.fields.CharField')(max_length=128, db_index=True)),
            ('from_nickname', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
            ('from_headimgurl', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
            ('from_ipaddr', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('is_good_vote', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('current_good_vote', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('current_bad_vote', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('current_annual_bonus', self.gf('django.db.models.fields.IntegerField')(default=1000)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'wanglibao_reward', ['WeixinAnnulBonusVote'])

        # Adding unique constraint on 'WeixinAnnulBonusVote', fields ['from_openid', 'to_openid']
        db.create_unique(u'wanglibao_reward_weixinannulbonusvote', ['from_openid', 'to_openid'])


    def backwards(self, orm):
        # Removing unique constraint on 'WeixinAnnulBonusVote', fields ['from_openid', 'to_openid']
        db.delete_unique(u'wanglibao_reward_weixinannulbonusvote', ['from_openid', 'to_openid'])

        # Deleting model 'WeixinAnnualBonus'
        db.delete_table(u'wanglibao_reward_weixinannualbonus')

        # Deleting model 'WeixinAnnulBonusVote'
        db.delete_table(u'wanglibao_reward_weixinannulbonusvote')
