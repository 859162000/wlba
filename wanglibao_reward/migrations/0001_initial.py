...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WanglibaoActivityGiftGlobalCfg'
        db.create_table(u'wanglibao_reward_wanglibaoactivitygiftglobalcfg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_activity.Activity'])),
        ...
        # Adding model 'WanglibaoActivityGift'
        db.create_table(u'wanglibao_reward_wanglibaoactivitygift', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gift_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_activity.Activity'])),
            ('redpack', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_redpack.RedPackEvent'])),
            ('cfg', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_reward.WanglibaoActivityGiftGlobalCfg'])),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('chances', self.gf('django.db.models.fields.IntegerField')(default=3)),
            ('name', self.gf('django.db.models.fields.CharField')(default=u'\u7ea2\u5305', max_length=128)),
            ('rate', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('send_rate', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('each_day_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('channels', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('valid', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'wanglibao_reward', ['WanglibaoActivityGift'])

        # Adding model 'WanglibaoUserGift'
    ...
    def backwards(self, orm):
        # Deleting model 'WanglibaoActivityGiftGlobalCfg'
        db.delete_table(u'wanglibao_reward_wanglibaoactivitygiftglobalcfg')

        # Deleting model 'WanglibaoActivityGift'
        db.delete_table(u'wanglibao_reward_wanglibaoactivitygift')

        # Deleting model 'WanglibaoUserGift'
        db.delete_table(u'wanglibao_reward_wanglibaousergift')

        # Deleting model 'WanglibaoWeixinRelative'
        db.delete_table(u'wanglibao_reward_wanglibaoweixinrelative')
