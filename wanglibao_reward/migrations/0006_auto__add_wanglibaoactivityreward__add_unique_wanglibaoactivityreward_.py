...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WanglibaoActivityReward'
        db.create_table(u'wanglibao_reward_wanglibaoactivityreward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reward_owner', on_delete=models.SET_NULL, default=None, to=orm['auth.User'], blank=True, null=True)),
            ('redpack_event', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wanglibao_redpack.RedPackEvent'])),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['marketing.Reward'])),
        ...
        db.send_create_signal(u'wanglibao_reward', ['WanglibaoActivityReward'])

        # Adding unique constraint on 'WanglibaoActivityReward', fields ['user', 'create_at']
        db.create_unique(u'wanglibao_reward_wanglibaoactivityreward', ['user_id', 'create_at'])


    def backwards(self, orm):
        # Removing unique constraint on 'WanglibaoActivityReward', fields ['user', 'create_at']
        db.delete_unique(u'wanglibao_reward_wanglibaoactivityreward', ['user_id', 'create_at'])

        # Deleting model 'WanglibaoActivityReward'
        db.delete_table(u'wanglibao_reward_wanglibaoactivityreward')
    ...
    models = {
        ...
        u'wanglibao_reward.wanglibaoactivityreward': {
            ...
            'redpack_event': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['wanglibao_redpack.RedPackEvent']"}),
            'reward': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['marketing.Reward']"}),
