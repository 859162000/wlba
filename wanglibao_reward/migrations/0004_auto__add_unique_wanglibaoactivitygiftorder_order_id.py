...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WanglibaoActivityGiftOrder', fields ['order_id']
        db.create_unique(u'wanglibao_reward_wanglibaoactivitygiftorder', ['order_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WanglibaoActivityGiftOrder', fields ['order_id']
        db.delete_unique(u'wanglibao_reward_wanglibaoactivitygiftorder', ['order_id'])
