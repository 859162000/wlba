...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WanglibaoWeixinRelative.user'
        db.alter_column(u'wanglibao_reward_wanglibaoweixinrelative', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'WanglibaoWeixinRelative.user'
        db.alter_column(u'wanglibao_reward_wanglibaoweixinrelative', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
