...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActivityRewardRecord'
        db.create_table(u'wanglibao_reward_activityrewardrecord', (
            ...
            ('activity_code_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ...
            ('redpack_record_id_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'wanglibao_reward', ['ActivityRewardRecord'])

        # Adding unique constraint on 'ActivityRewardRecord', fields ['user', 'create_date']
        db.create_unique(u'wanglibao_reward_activityrewardrecord', ['user_id', 'create_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'ActivityRewardRecord', fields ['user', 'create_date']
        db.delete_unique(u'wanglibao_reward_activityrewardrecord', ['user_id', 'create_date'])

        # Deleting model 'ActivityRewardRecord'
        db.delete_table(u'wanglibao_reward_activityrewardrecord')
    ...
    models = {
        ...
        u'wanglibao_reward.activityrewardrecord': {
            'Meta': {'unique_together': "(('user', 'create_date'),)", 'object_name': 'ActivityRewardRecord'},
