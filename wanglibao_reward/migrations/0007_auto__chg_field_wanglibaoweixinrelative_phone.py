...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WanglibaoWeixinRelative.phone'
        db.alter_column(u'wanglibao_reward_wanglibaoweixinrelative', 'phone', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'WanglibaoWeixinRelative.phone'
        db.alter_column(u'wanglibao_reward_wanglibaoweixinrelative', 'phone', self.gf('django.db.models.fields.IntegerField')())
