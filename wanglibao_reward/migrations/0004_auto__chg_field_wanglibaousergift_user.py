...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WanglibaoUserGift.user'
        db.alter_column(u'wanglibao_reward_wanglibaousergift', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'WanglibaoUserGift.user'
        db.alter_column(u'wanglibao_reward_wanglibaousergift', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
