...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoActivityGiftGlobalCfg.amount'
        db.add_column(u'wanglibao_reward_wanglibaoactivitygiftglobalcfg', 'amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoActivityGiftGlobalCfg.amount'
        db.delete_column(u'wanglibao_reward_wanglibaoactivitygiftglobalcfg', 'amount')
