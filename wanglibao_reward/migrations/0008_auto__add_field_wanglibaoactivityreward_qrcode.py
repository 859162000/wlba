...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoActivityReward.qrcode'
        db.add_column(u'wanglibao_reward_wanglibaoactivityreward', 'qrcode',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoActivityReward.qrcode'
        db.delete_column(u'wanglibao_reward_wanglibaoactivityreward', 'qrcode')
