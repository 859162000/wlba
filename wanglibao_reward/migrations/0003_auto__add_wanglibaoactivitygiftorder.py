...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WanglibaoActivityGiftOrder'
        db.create_table(u'wanglibao_reward_wanglibaoactivitygiftorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('valid_amount', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('order_id', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'wanglibao_reward', ['WanglibaoActivityGiftOrder'])


    def backwards(self, orm):
        # Deleting model 'WanglibaoActivityGiftOrder'
        db.delete_table(u'wanglibao_reward_wanglibaoactivitygiftorder')
