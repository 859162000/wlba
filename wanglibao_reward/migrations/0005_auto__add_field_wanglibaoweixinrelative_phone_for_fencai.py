...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WanglibaoWeixinRelative.phone_for_fencai'
        db.add_column(u'wanglibao_reward_wanglibaoweixinrelative', 'phone_for_fencai',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WanglibaoWeixinRelative.phone_for_fencai'
        db.delete_column(u'wanglibao_reward_wanglibaoweixinrelative', 'phone_for_fencai')
