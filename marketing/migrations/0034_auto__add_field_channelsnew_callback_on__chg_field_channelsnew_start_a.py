...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChannelsNew.callback_on'
        db.add_column(u'marketing_channelsnew', 'callback_on',
                      self.gf('django.db.models.fields.CharField')(default='----', max_length=20),
                      keep_default=False)


        # Changing field 'ChannelsNew.start_at'
        db.alter_column(u'marketing_channelsnew', 'start_at', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ChannelsNew.end_at'
        db.alter_column(u'marketing_channelsnew', 'end_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'ChannelsNew.callback_on'
        db.delete_column(u'marketing_channelsnew', 'callback_on')


        # Changing field 'ChannelsNew.start_at'
        db.alter_column(u'marketing_channelsnew', 'start_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ChannelsNew.end_at'
        db.alter_column(u'marketing_channelsnew', 'end_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        u'marketing.channelsnew': {
            ...
            'callback_on': ('django.db.models.fields.CharField', [], {'default': "'----'", 'max_length': '20'}),
            'classification': ('django.db.models.fields.CharField', [], {'default': "'coop'", 'max_length': '20'}),
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12', 'db_index': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'is_stop': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20'}),
            'source_for': ('django.db.models.fields.CharField', [], {'default': "'full'", 'max_length': '20'}),
            'start_at': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'})
        },
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'eJBwT57MTxqzMuciS4cHOQ'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 25, 0, 0)'}),
