...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IntroducedByReward'
        db.create_table(u'marketing_introducedbyreward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('introduced_by_person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='introduced_person', to=orm['auth.User'])),
            ...
            ('first_bought_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('first_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('first_reward', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('introduced_reward', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('activity_start_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('activity_end_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('activity_amount_min', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('percent_reward', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('checked_status', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('checked_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'marketing', ['IntroducedByReward'])


    def backwards(self, orm):
        # Deleting model 'IntroducedByReward'
        db.delete_table(u'marketing_introducedbyreward')
    ...
    models = {
        ...
        u'marketing.introducedbyreward': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'introduced_by_person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'introduced_person'", 'to': u"orm['auth.User']"}),
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'XJPXbI5sRE6NILl_7zlW3Q'", 'max_length': '64', 'db_index': 'True'}),
