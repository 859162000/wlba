...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActivityRule.create_time'
        db.alter_column(u'marketing_activityrule', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ActivityRule.create_time'
        db.alter_column(u'marketing_activityrule', 'create_time', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'_NmlOGvzTNq2O5vBkkHLDQ'", 'max_length': '64', 'db_index': 'True'}),
