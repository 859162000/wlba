...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuickApplyInfo'
        db.create_table(u'marketing_quickapplyinfo', (
            ...
            ('apply_way', self.gf('django.db.models.fields.IntegerField')(default=2, max_length=2)),
            ('apply_amount', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=32)),
        ))
        db.send_create_signal(u'marketing', ['QuickApplyInfo'])


    def backwards(self, orm):
        # Deleting model 'QuickApplyInfo'
        db.delete_table(u'marketing_quickapplyinfo')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'JMu_DFq4TYmCM9zBUyy0DQ'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 22, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 12, 0, 0)'}),
