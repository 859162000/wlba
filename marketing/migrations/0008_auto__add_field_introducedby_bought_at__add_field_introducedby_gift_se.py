...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntroducedBy.bought_at'
        db.add_column(u'marketing_introducedby', 'bought_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'IntroducedBy.gift_send_at'
        db.add_column(u'marketing_introducedby', 'gift_send_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntroducedBy.bought_at'
        db.delete_column(u'marketing_introducedby', 'bought_at')

        # Deleting field 'IntroducedBy.gift_send_at'
        db.delete_column(u'marketing_introducedby', 'gift_send_at')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'WcDigQmwRCyf64p1yDuMMg'", 'max_length': '64', 'db_index': 'True'}),
