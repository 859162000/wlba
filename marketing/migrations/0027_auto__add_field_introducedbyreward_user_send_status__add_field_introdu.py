...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntroducedByReward.user_send_status'
        db.add_column(u'marketing_introducedbyreward', 'user_send_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'IntroducedByReward.user_send_amount'
        db.add_column(u'marketing_introducedbyreward', 'user_send_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'IntroducedByReward.introduced_send_status'
        db.add_column(u'marketing_introducedbyreward', 'introduced_send_status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'IntroducedByReward.introduced_send_amount'
        db.add_column(u'marketing_introducedbyreward', 'introduced_send_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntroducedByReward.user_send_status'
        db.delete_column(u'marketing_introducedbyreward', 'user_send_status')

        # Deleting field 'IntroducedByReward.user_send_amount'
        db.delete_column(u'marketing_introducedbyreward', 'user_send_amount')

        # Deleting field 'IntroducedByReward.introduced_send_status'
        db.delete_column(u'marketing_introducedbyreward', 'introduced_send_status')

        # Deleting field 'IntroducedByReward.introduced_send_amount'
        db.delete_column(u'marketing_introducedbyreward', 'introduced_send_amount')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'WCXgCunQQ0axwqmX4RO1ww'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 22, 0, 0)'}),
