...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'marketing_invitecode', (
            ('code', self.gf('django.db.models.fields.CharField')(max_length=6, unique=True, db_index=True)),
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'h4Lu8ldJRRa5Ay6j1BXYkA'", 'max_length': '64', 'db_index': 'True'}),
