...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marketing_p2prewardrecord', (
            ...
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.P2PReward'])),
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'1K-W7jgBQLG7cBYnbZuXwQ'", 'max_length': '64', 'db_index': 'True'}),
