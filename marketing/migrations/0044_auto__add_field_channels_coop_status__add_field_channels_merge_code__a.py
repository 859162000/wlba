...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channels.coop_status'
        db.add_column(u'marketing_channels', 'coop_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'Channels.merge_code'
        db.add_column(u'marketing_channels', 'merge_code',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channels.classification'
        db.add_column(u'marketing_channels', 'classification',
                      self.gf('django.db.models.fields.CharField')(default='----', max_length=20),
                      keep_default=False)

        # Adding field 'Channels.platform'
        db.add_column(u'marketing_channels', 'platform',
                      self.gf('django.db.models.fields.CharField')(default='full', max_length=20),
                      keep_default=False)

        # Adding field 'Channels.start_at'
        db.add_column(u'marketing_channels', 'start_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channels.end_at'
        db.add_column(u'marketing_channels', 'end_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Channels.is_abandoned'
        db.add_column(u'marketing_channels', 'is_abandoned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Channels.code'
        db.alter_column(u'marketing_channels', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=12))

    def backwards(self, orm):
        # Deleting field 'Channels.coop_status'
        db.delete_column(u'marketing_channels', 'coop_status')

        # Deleting field 'Channels.merge_code'
        db.delete_column(u'marketing_channels', 'merge_code')

        # Deleting field 'Channels.classification'
        db.delete_column(u'marketing_channels', 'classification')

        # Deleting field 'Channels.platform'
        db.delete_column(u'marketing_channels', 'platform')

        # Deleting field 'Channels.start_at'
        db.delete_column(u'marketing_channels', 'start_at')

        # Deleting field 'Channels.end_at'
        db.delete_column(u'marketing_channels', 'end_at')

        # Deleting field 'Channels.is_abandoned'
        db.delete_column(u'marketing_channels', 'is_abandoned')


        # Changing field 'Channels.code'
        db.alter_column(u'marketing_channels', 'code', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'4_i7GmeMSYyJGF2Ka3NBHA'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 20, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 10, 0, 0)'}),
