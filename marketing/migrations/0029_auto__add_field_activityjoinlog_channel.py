...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityJoinLog.channel'
        db.add_column(u'marketing_activityjoinlog', 'channel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActivityJoinLog.channel'
        db.delete_column(u'marketing_activityjoinlog', 'channel')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'k5z76liNTGKYdSqfWPEm_Q'", 'max_length': '64', 'db_index': 'True'}),
