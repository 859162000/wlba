...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ClientData', fields ['user_id']
        db.create_index(u'marketing_clientdata', ['user_id'])

        # Adding index on 'ClientData', fields ['action']
        db.create_index(u'marketing_clientdata', ['action'])


    def backwards(self, orm):
        # Removing index on 'ClientData', fields ['action']
        db.delete_index(u'marketing_clientdata', ['action'])

        # Removing index on 'ClientData', fields ['user_id']
        db.delete_index(u'marketing_clientdata', ['user_id'])
    ...
    models = {
        ...
        u'marketing.clientdata': {
            ...
            'action': ('django.db.models.fields.CharField', [], {'max_length': '10', 'db_index': 'True'}),
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'G73UpMS9TrmDusCUqnbu0g'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 12, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 2, 0, 0)', 'db_index': 'True'}),
