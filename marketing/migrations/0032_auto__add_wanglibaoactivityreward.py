...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marketing_wanglibaoactivityreward', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('activity_id', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('total_chances', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('used_chances', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('total_awards', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('used_awards', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'marketing', ['WanglibaoActivityReward'])


    def backwards(self, orm):
        # Deleting model 'WanglibaoActivityReward'
        db.delete_table(u'marketing_wanglibaoactivityreward')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'Qs6lvV8KTHK4NqcU1fXQ0A'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 7, 0, 0)'}),
