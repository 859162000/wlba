...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsAndReport.image'
        db.add_column(u'marketing_newsandreport', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsAndReport.image'
        db.delete_column(u'marketing_newsandreport', 'image')
