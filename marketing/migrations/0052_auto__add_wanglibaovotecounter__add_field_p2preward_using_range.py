...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'marketing.p2preward': {
            ...
            'conversion_code': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'marketing.p2prewardrecord': {
            ...
            'reward': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fk_reward'", 'to': u"orm['marketing.P2PReward']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
