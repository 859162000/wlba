...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClientData.phone'
        db.delete_column(u'marketing_clientdata', 'phone')

        # Deleting field 'ClientData.channelid'
        db.delete_column(u'marketing_clientdata', 'channelid')

        # Adding field 'ClientData.os'
        db.add_column(u'marketing_clientdata', 'os',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'ClientData.os_version'
        db.add_column(u'marketing_clientdata', 'os_version',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30),
                      keep_default=False)

        # Adding field 'ClientData.channel'
        db.add_column(u'marketing_clientdata', 'channel',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'ClientData.user_id'
        db.add_column(u'marketing_clientdata', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ClientData.amount'
        db.add_column(u'marketing_clientdata', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


        # Changing field 'ClientData.userdevice'
        db.alter_column(u'marketing_clientdata', 'userdevice', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Changing field 'ClientData.create_time'
        db.alter_column(u'marketing_clientdata', 'create_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'ClientData.action'
        db.alter_column(u'marketing_clientdata', 'action', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Adding field 'ClientData.phone'
        db.add_column(u'marketing_clientdata', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)

        # Adding field 'ClientData.channelid'
        db.add_column(u'marketing_clientdata', 'channelid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=120),
                      keep_default=False)

        # Deleting field 'ClientData.os'
        db.delete_column(u'marketing_clientdata', 'os')

        # Deleting field 'ClientData.os_version'
        db.delete_column(u'marketing_clientdata', 'os_version')

        # Deleting field 'ClientData.channel'
        db.delete_column(u'marketing_clientdata', 'channel')

        # Deleting field 'ClientData.user_id'
        db.delete_column(u'marketing_clientdata', 'user_id')

        # Deleting field 'ClientData.amount'
        db.delete_column(u'marketing_clientdata', 'amount')


        # Changing field 'ClientData.userdevice'
        db.alter_column(u'marketing_clientdata', 'userdevice', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'ClientData.create_time'
        db.alter_column(u'marketing_clientdata', 'create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ClientData.action'
        db.alter_column(u'marketing_clientdata', 'action', self.gf('django.db.models.fields.IntegerField')(max_length=2))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'1VKjpkI2QG2qln-Tpq07-w'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 9, 0, 0)'}),
