...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntroducedBy.product_id'
        db.add_column(u'marketing_introducedby', 'product_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntroducedBy.product_id'
        db.delete_column(u'marketing_introducedby', 'product_id')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'73LVfCf8SAmn7C_zfztk9w'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 12, 0, 0)'}),
