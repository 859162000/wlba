...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marketing_activity', (
            ...
            ('rule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.ActivityRule'], null=True, on_delete=models.SET_NULL)),
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'L_EN4e1_Ty2hWS4cLz__yw'", 'max_length': '64', 'db_index': 'True'}),
