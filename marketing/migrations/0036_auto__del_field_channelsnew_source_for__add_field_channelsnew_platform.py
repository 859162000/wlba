...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChannelsNew.source_for'
        db.delete_column(u'marketing_channelsnew', 'source_for')

        # Adding field 'ChannelsNew.platform'
        db.add_column(u'marketing_channelsnew', 'platform',
                      self.gf('django.db.models.fields.CharField')(default='full', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChannelsNew.source_for'
        db.add_column(u'marketing_channelsnew', 'source_for',
                      self.gf('django.db.models.fields.CharField')(default='full', max_length=20),
                      keep_default=False)

        # Deleting field 'ChannelsNew.platform'
        db.delete_column(u'marketing_channelsnew', 'platform')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'6JzI7aE0SIGNdDCQ3v_PCw'", 'max_length': '64', 'db_index': 'True'}),
