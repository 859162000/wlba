...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'marketing_clientdata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('userdevice', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('network', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('channelid', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('action', self.gf('django.db.models.fields.IntegerField')(max_length=2)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'marketing', ['ClientData'])


    def backwards(self, orm):
        # Deleting model 'ClientData'
        db.delete_table(u'marketing_clientdata')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'wBknU-R-TnqhaIollE7gOA'", 'max_length': '64', 'db_index': 'True'}),
