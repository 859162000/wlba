...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChannelsNew.callback'
        db.delete_column(u'marketing_channelsnew', 'callback')


        # Changing field 'ChannelsNew.coop_status'
        db.alter_column(u'marketing_channelsnew', 'coop_status', self.gf('django.db.models.fields.IntegerField')(max_length=2))

    def backwards(self, orm):
        # Adding field 'ChannelsNew.callback'
        db.add_column(u'marketing_channelsnew', 'callback',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


        # Changing field 'ChannelsNew.coop_status'
        db.alter_column(u'marketing_channelsnew', 'coop_status', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'FT1v-IzITzWKg1fbXm7V3g'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 14, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 4, 0, 0)'}),
