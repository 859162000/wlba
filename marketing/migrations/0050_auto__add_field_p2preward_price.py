...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P2PReward.price'
        db.add_column(u'marketing_p2preward', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P2PReward.price'
        db.delete_column(u'marketing_p2preward', 'price')
    ...
    models = {
        ...
        u'marketing.p2preward': {
            'Meta': {'ordering': "['-create_time']", 'object_name': 'P2PReward'},
        ...
        u'marketing.p2prewardrecord': {
            ...
            'reward': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marketing.P2PReward']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'Mb1ukJHJTWGZrFZw7UyrtQ'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 29, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 12, 19, 0, 0)'}),
