...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LoginAccessToken'
        db.create_table(u'marketing_loginaccesstoken', (
            ('token', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['authtoken.Token'], unique=True, primary_key=True)),
            ('secret_sign', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40)),
            ('expire_at', self.gf('django.db.models.fields.BigIntegerField')(default=None, blank=True)),
        ))
        db.send_create_signal(u'marketing', ['LoginAccessToken'])


    def backwards(self, orm):
        # Deleting model 'LoginAccessToken'
        db.delete_table(u'marketing_loginaccesstoken')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'0JjEHTt3SVqjJTAWb6ULIA'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 10, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 31, 0, 0)'}),
