...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimelySiteData'
        db.create_table(u'marketing_timelysitedata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('p2p_margin', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
            ('freeze_amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2)),
        ...
        db.send_create_signal(u'marketing', ['TimelySiteData'])


    def backwards(self, orm):
        # Deleting model 'TimelySiteData'
        db.delete_table(u'marketing_timelysitedata')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2O3nuX6HRXuLitdxBCWxrg'", 'max_length': '64', 'db_index': 'True'}),
