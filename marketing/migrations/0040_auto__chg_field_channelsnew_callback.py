...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChannelsNew.callback'
        db.alter_column(u'marketing_channelsnew', 'callback', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ChannelsNew.callback'
        db.alter_column(u'marketing_channelsnew', 'callback', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'marketing.channelsnew': {
            ...
            'callback': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'_WD5kd5eQ1K1DiMxuQQ96Q'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 28, 0, 0)'}),
