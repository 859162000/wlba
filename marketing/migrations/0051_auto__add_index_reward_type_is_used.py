...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Reward', fields ['type', 'is_used']
        db.create_index(u'marketing_reward', ['type', 'is_used'])


    def backwards(self, orm):
        # Removing index on 'Reward', fields ['type', 'is_used']
        db.delete_index(u'marketing_reward', ['type', 'is_used'])
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'GagjLmItSzqpN371RyTEQA'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 17, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 7, 0, 0)', 'db_index': 'True'}),
