...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'marketing_activityrule', 'rule_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=4))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'voyizglDQq6PfPfDzgH0Ng'", 'max_length': '64', 'db_index': 'True'}),
