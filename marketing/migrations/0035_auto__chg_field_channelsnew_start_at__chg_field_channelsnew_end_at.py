...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'marketing_channelsnew', 'start_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ChannelsNew.end_at'
        db.alter_column(u'marketing_channelsnew', 'end_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'ChannelsNew.start_at'
        db.alter_column(u'marketing_channelsnew', 'start_at', self.gf('django.db.models.fields.DateTimeField')(default=''))

        # Changing field 'ChannelsNew.end_at'
        db.alter_column(u'marketing_channelsnew', 'end_at', self.gf('django.db.models.fields.DateTimeField')(default=''))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'sZ5TaCurRO6ikMRCWtd7BA'", 'max_length': '64', 'db_index': 'True'}),
