...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channels.is_show_invite_code'
        db.add_column(u'marketing_channels', 'is_show_invite_code',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channels.is_show_invite_code'
        db.delete_column(u'marketing_channels', 'is_show_invite_code')
    ...
    models = {
        ...
        u'marketing.channels': {
            ...
            'is_show_invite_code': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'ZlnqYRgVQhqNMNrlz3a3Zg'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 5, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 25, 0, 0)', 'db_index': 'True'}),
