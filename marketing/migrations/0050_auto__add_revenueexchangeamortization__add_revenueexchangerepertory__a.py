...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RevenueExchangeAmortization'
        db.create_table(u'marketing_revenueexchangeamortization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('product_amortization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reward_subs', to=orm['wanglibao_p2p.ProductAmortization'])),
            ('term', self.gf('django.db.models.fields.IntegerField')()),
            ('term_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('term_amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2)),
            ('revenue_amount', self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=20, decimal_places=2)),
            ...
            ('exchanged', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('exchange_id', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True, blank=True)),
            ('exchange_parts', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('exchange_result', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('exchange_method', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('exchange_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('order_id', self.gf('django.db.models.fields.CharField')(max_length=30, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'marketing', ['RevenueExchangeAmortization'])

        # Adding model 'RevenueExchangeRepertory'
        db.create_table(u'marketing_revenueexchangerepertory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('conversion_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True)),
            ('exchange_id', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True, blank=True)),
        ))
        ...
        db.create_table(u'marketing_revenueexchangeorder', (
            ...
            ('parts', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('reward_rule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.RevenueExchangeRule'])),
            ('order_id', self.gf('django.db.models.fields.IntegerField')(unique=True, db_index=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'marketing_revenueexchangeamortization')
    ...
    models = {
        ...
        u'marketing.revenueexchangeamortization': {
            'Meta': {'ordering': "['-create_time']", 'object_name': 'RevenueExchangeAmortization'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'exchange_id': ('django.db.models.fields.IntegerField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'exchange_method': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'exchange_parts': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'exchange_result': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'exchange_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'exchanged': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_id': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True'}),
            'product_amortization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reward_subs'", 'to': u"orm['wanglibao_p2p.ProductAmortization']"}),
            'revenue_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            ...
            'term_amount': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '20', 'decimal_places': '2'}),
            'term_date': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'marketing.revenueexchangeorder': {
            'Meta': {'ordering': "['-created_time']", 'object_name': 'RevenueExchangeOrder'},
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order_id': ('django.db.models.fields.IntegerField', [], {'unique': 'True', 'db_index': 'True'}),
            'parts': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'product_id': ('django.db.models.fields.IntegerField', [], {}),
            'reward_name': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'reward_rule': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marketing.RevenueExchangeRule']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'marketing.revenueexchangerepertory': {
            'Meta': {'ordering': "['-create_time']", 'object_name': 'RevenueExchangeRepertory'},
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['marketing.Channels']"}),
            'conversion_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'marketing.revenueexchangerule': {
        ...
        u'wanglibao_p2p.productamortization': {
            ...
            'is_auto_ready_for_settle': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
