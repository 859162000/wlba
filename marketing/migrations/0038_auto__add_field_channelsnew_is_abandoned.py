...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChannelsNew.is_abandoned'
        db.add_column(u'marketing_channelsnew', 'is_abandoned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChannelsNew.is_abandoned'
        db.delete_column(u'marketing_channelsnew', 'is_abandoned')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'V9YFaIOHSDm_SPtV_7jTZg'", 'max_length': '64', 'db_index': 'True'}),
