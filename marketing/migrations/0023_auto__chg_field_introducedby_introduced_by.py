...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IntroducedBy.introduced_by'
        db.alter_column(u'marketing_introducedby', 'introduced_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'IntroducedBy.introduced_by'
        db.alter_column(u'marketing_introducedby', 'introduced_by_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'7GmDhpkJQ3OkbwbOgbALCw'", 'max_length': '64', 'db_index': 'True'}),
