...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChannelsNew.is_stop'
        db.delete_column(u'marketing_channelsnew', 'is_stop')

        # Adding field 'ChannelsNew.coop_status'
        db.add_column(u'marketing_channelsnew', 'coop_status',
                      self.gf('django.db.models.fields.CharField')(default='coop', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChannelsNew.is_stop'
        db.add_column(u'marketing_channelsnew', 'is_stop',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ChannelsNew.coop_status'
        db.delete_column(u'marketing_channelsnew', 'coop_status')
    ...
    models = {
        ...
        u'marketing.channelsnew': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '12', 'db_index': 'True'}),
            'coop_status': ('django.db.models.fields.CharField', [], {'default': "'coop'", 'max_length': '20'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'7P-qMka3SvaQtyJ6fjOJhg'", 'max_length': '64', 'db_index': 'True'}),
