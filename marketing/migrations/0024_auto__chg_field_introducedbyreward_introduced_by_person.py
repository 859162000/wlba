...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IntroducedByReward.introduced_by_person'
        db.alter_column(u'marketing_introducedbyreward', 'introduced_by_person_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'IntroducedByReward.introduced_by_person'
        db.alter_column(u'marketing_introducedbyreward', 'introduced_by_person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'SxI5MB0vRf62usfyOIGYVQ'", 'max_length': '64', 'db_index': 'True'}),
