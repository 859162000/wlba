...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channels.describe'
        db.add_column(u'marketing_channels', 'describe',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channels.describe'
        db.delete_column(u'marketing_channels', 'describe')
    ...
    models = {
        ...
        u'marketing.channels': {
            ...
            'describe': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'8gCzplu4Th29Qz1sPu6Ilw'", 'max_length': '64', 'db_index': 'True'}),
