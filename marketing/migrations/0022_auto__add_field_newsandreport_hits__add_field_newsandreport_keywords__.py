...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsAndReport.hits'
        db.add_column(u'marketing_newsandreport', 'hits',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'NewsAndReport.keywords'
        db.add_column(u'marketing_newsandreport', 'keywords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsAndReport.description'
        db.add_column(u'marketing_newsandreport', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'NewsAndReport.content'
        db.add_column(u'marketing_newsandreport', 'content',
                      self.gf('ckeditor.fields.RichTextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsAndReport.hits'
        db.delete_column(u'marketing_newsandreport', 'hits')

        # Deleting field 'NewsAndReport.keywords'
        db.delete_column(u'marketing_newsandreport', 'keywords')

        # Deleting field 'NewsAndReport.description'
        db.delete_column(u'marketing_newsandreport', 'description')

        # Deleting field 'NewsAndReport.content'
        db.delete_column(u'marketing_newsandreport', 'content')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'3KKiuhT8RAGw2dm57AljYQ'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 12, 0, 0)'}),
