...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GiftOwnerInfo'
        db.create_table(u'marketing_giftownerinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.GiftOwnerGlobalInfo'])),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
            ('phone', self.gf('django.db.models.fields.CharField')(default='', max_length=32, db_index=True)),
            ('address', self.gf('django.db.models.fields.CharField')(default='', max_length=256)),
            ('award', self.gf('django.db.models.fields.CharField')(default='', max_length=64, db_index=True)),
            ('type', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('update_time', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'marketing', ['GiftOwnerInfo'])

        # Adding model 'GiftOwnerGlobalInfo'
        db.create_table(u'marketing_giftownerglobalinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('amount', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True)),
        ...
        db.send_create_signal(u'marketing', ['GiftOwnerGlobalInfo'])

        # Adding index on 'QuickApplyInfo', fields ['phone']
        db.create_index(u'marketing_quickapplyinfo', ['phone'])


    def backwards(self, orm):
        # Removing index on 'QuickApplyInfo', fields ['phone']
        db.delete_index(u'marketing_quickapplyinfo', ['phone'])

        # Deleting model 'GiftOwnerInfo'
        db.delete_table(u'marketing_giftownerinfo')

        # Deleting model 'GiftOwnerGlobalInfo'
        db.delete_table(u'marketing_giftownerglobalinfo')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'U8_Eex2RQem2Azp0chbtlA'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 23, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 13, 0, 0)'}),
