...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IntroducedBy.channel'
        db.add_column(u'marketing_introducedby', 'channel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marketing.Channels'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IntroducedBy.channel'
        db.delete_column(u'marketing_introducedby', 'channel_id')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'h4byE8-oS-Ogf5GI1k1YKQ'", 'max_length': '64', 'db_index': 'True'}),
