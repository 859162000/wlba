...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientData.order_id'
        db.add_column(u'marketing_clientdata', 'order_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientData.order_id'
        db.delete_column(u'marketing_clientdata', 'order_id')
