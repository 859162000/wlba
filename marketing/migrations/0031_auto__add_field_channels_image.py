...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Channels.image'
        db.add_column(u'marketing_channels', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Channels.image'
        db.delete_column(u'marketing_channels', 'image')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'TMZnue6jQbShB4UMZnVOUg'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 16, 0, 0)'}),
