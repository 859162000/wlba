...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PromotionToken'
        db.create_table(u'marketing_promotiontoken', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
        ))
        db.send_create_signal(u'marketing', ['PromotionToken'])

        # Adding model 'IntroducedBy'
        db.create_table(u'marketing_introducedby', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('introduced_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='introduces', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'marketing', ['IntroducedBy'])


    def backwards(self, orm):
        # Deleting model 'PromotionToken'
        db.delete_table(u'marketing_promotiontoken')

        # Deleting model 'IntroducedBy'
        db.delete_table(u'marketing_introducedby')
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'ap0Nmcz5Sn-uz0ddASWptw'", 'max_length': '64', 'db_index': 'True'}),
