...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'marketing_channels', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Channels.code'
        db.alter_column(u'marketing_channels', 'code', self.gf('django.db.models.fields.CharField')(max_length=12, unique=True))
    ...
    models = {
        ...
        u'marketing.promotiontoken': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'hwpL7iKmQFWxkvbq12ro-g'", 'max_length': '64', 'db_index': 'True'}),
        ...
        u'wanglibao_p2p.p2pproduct': {
            ...
            'end_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 16, 0, 0)'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 6, 0, 0)'}),
