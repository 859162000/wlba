...
from views import AggregateView, MarketingView, TvView, TopsView, IntroducedRewardTemplate, IntroducedAward
...
admin.site.register_view('statistics/introduced_by/query', view=IntroducedAward.as_view())
