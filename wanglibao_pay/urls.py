...
from wanglibao_pay.views import BankListView, PayCallback, WithdrawCompleteView, WithdrawCallback, PayView, WithdrawView, \
    ...
    YeeProxyPayCompleteView, BankListForRegisterView, CardConfigTemplateView, BaoProxyPayCallback, BaoProxyPayCompleteView
...
urlpatterns = patterns('',
    ...
    url(r'^deposit/bao_proxy_pay_complete/$', BaoProxyPayCompleteView.as_view(), name='baoproxypay-deposit-completeview'),
    url(r'^deposit/bao_proxy_pay_callback/$', BaoProxyPayCallback.as_view(), name='baoproxypay-deposit-callback'),
