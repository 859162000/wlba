...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WhiteListCard'
        db.create_table(u'wanglibao_pay_whitelistcard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT)),
            ('card_no', self.gf('django.db.models.fields.CharField')(max_length=25, db_index=True)),
        ...
        db.send_create_signal(u'wanglibao_pay', ['WhiteListCard'])

        # Adding model 'BlackListCard'
        db.create_table(u'wanglibao_pay_blacklistcard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], on_delete=models.PROTECT)),
            ('card_no', self.gf('django.db.models.fields.CharField')(max_length=25, db_index=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ...
        db.send_create_signal(u'wanglibao_pay', ['BlackListCard'])


    def backwards(self, orm):
        # Deleting model 'WhiteListCard'
        db.delete_table(u'wanglibao_pay_whitelistcard')

        # Deleting model 'BlackListCard'
        db.delete_table(u'wanglibao_pay_blacklistcard')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'iRIpbnjHTxKsQG6bAUiubQ'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'I8r0nGsDR1iS8yMGxiz1sw'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
