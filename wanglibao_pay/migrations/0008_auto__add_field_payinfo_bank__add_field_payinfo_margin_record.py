...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.bank'
        db.add_column(u'wanglibao_pay_payinfo', 'bank',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_pay.Bank'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'PayInfo.margin_record'
        db.add_column(u'wanglibao_pay_payinfo', 'margin_record',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_margin.MarginRecord'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayInfo.bank'
        db.delete_column(u'wanglibao_pay_payinfo', 'bank_id')

        # Deleting field 'PayInfo.margin_record'
        db.delete_column(u'wanglibao_pay_payinfo', 'margin_record_id')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'amount': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '2'}),
            'bank': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wanglibao_pay.Bank']", 'null': 'True', 'blank': 'True'}),
            'card': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wanglibao_pay.Card']", 'null': 'True', 'blank': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
