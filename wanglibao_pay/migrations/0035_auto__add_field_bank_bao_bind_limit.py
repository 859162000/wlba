...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bank.bao_bind_limit'
        db.add_column(u'wanglibao_pay_bank', 'bao_bind_limit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bank.bao_bind_limit'
        db.delete_column(u'wanglibao_pay_bank', 'bao_bind_limit')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4gGtofFGS4uiH4rJa2ElEg'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'15csuV61RGi1pxwi95oSSQ'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
