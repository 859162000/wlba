...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bank.huifu_bind_limit'
        db.add_column(u'wanglibao_pay_bank', 'huifu_bind_limit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Bank.huifu_bind_code'
        db.add_column(u'wanglibao_pay_bank', 'huifu_bind_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Bank.yee_bind_limit'
        db.add_column(u'wanglibao_pay_bank', 'yee_bind_limit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'Bank.yee_bind_code'
        db.add_column(u'wanglibao_pay_bank', 'yee_bind_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Bank.channel'
        db.add_column(u'wanglibao_pay_bank', 'channel',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Card.is_bind_huifu'
        db.add_column(u'wanglibao_pay_card', 'is_bind_huifu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Card.is_bind_kuai'
        db.add_column(u'wanglibao_pay_card', 'is_bind_kuai',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Card.is_bind_yee'
        db.add_column(u'wanglibao_pay_card', 'is_bind_yee',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Bank.huifu_bind_limit'
        db.delete_column(u'wanglibao_pay_bank', 'huifu_bind_limit')

        # Deleting field 'Bank.huifu_bind_code'
        db.delete_column(u'wanglibao_pay_bank', 'huifu_bind_code')

        # Deleting field 'Bank.yee_bind_limit'
        db.delete_column(u'wanglibao_pay_bank', 'yee_bind_limit')

        # Deleting field 'Bank.yee_bind_code'
        db.delete_column(u'wanglibao_pay_bank', 'yee_bind_code')

        # Deleting field 'Bank.channel'
        db.delete_column(u'wanglibao_pay_bank', 'channel')

        # Deleting field 'Card.is_bind_huifu'
        db.delete_column(u'wanglibao_pay_card', 'is_bind_huifu')

        # Deleting field 'Card.is_bind_kuai'
        db.delete_column(u'wanglibao_pay_card', 'is_bind_kuai')

        # Deleting field 'Card.is_bind_yee'
        db.delete_column(u'wanglibao_pay_card', 'is_bind_yee')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'To_HFmwtRlmSQe0RdH02yw'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
