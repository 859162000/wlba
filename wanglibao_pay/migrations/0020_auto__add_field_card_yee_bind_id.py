...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.yee_bind_id'
        db.add_column(u'wanglibao_pay_card', 'yee_bind_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.yee_bind_id'
        db.delete_column(u'wanglibao_pay_card', 'yee_bind_id')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'A3ZvXpfiTi-nCM0hzyEGWw'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
