...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bank.have_company_channel'
        db.add_column(u'wanglibao_pay_bank', 'have_company_channel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bank.have_company_channel'
        db.delete_column(u'wanglibao_pay_bank', 'have_company_channel')
