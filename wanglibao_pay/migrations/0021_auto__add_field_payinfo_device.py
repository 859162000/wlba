...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.device'
        db.add_column(u'wanglibao_pay_payinfo', 'device',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayInfo.device'
        db.delete_column(u'wanglibao_pay_payinfo', 'device')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ybjYXFNuSiipPJq8xq7L3g'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
