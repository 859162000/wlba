...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Card.add_at'
        db.alter_column(u'wanglibao_pay_card', 'add_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Card.add_at'
        db.alter_column(u'wanglibao_pay_card', 'add_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'-9yauT_KS7WkVeIIEijeoA'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'yttFQZg7QI6UuNNe0IcUoA'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
