...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'wanglibao_pay_payinfo', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='bTC0Bs1cSrueHgm4LldB6A', unique=True, max_length=32, db_index=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fwQHPmTfRKmPXvGof3ygGQ'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
