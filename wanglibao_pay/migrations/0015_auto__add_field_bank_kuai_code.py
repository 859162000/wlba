...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bank.kuai_code'
        db.add_column(u'wanglibao_pay_bank', 'kuai_code',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bank.kuai_code'
        db.delete_column(u'wanglibao_pay_bank', 'kuai_code')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'W40ihVDiTfS1k3MrbB6T4Q'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
