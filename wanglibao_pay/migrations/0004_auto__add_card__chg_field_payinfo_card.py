...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Card'
        db.create_table(u'wanglibao_pay_card', (
        ...
        db.send_create_signal(u'wanglibao_pay', ['Card'])


        # Changing field 'PayInfo.card'
        db.alter_column(u'wanglibao_pay_payinfo', 'card_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_pay.Card'], null=True))

    def backwards(self, orm):
        # Deleting model 'Card'
        db.delete_table(u'wanglibao_pay_card')


        # Changing field 'PayInfo.card'
        db.alter_column(u'wanglibao_pay_payinfo', 'card_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wanglibao_buy.BindBank'], null=True))
