...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bank.bao_bind_code'
        db.add_column(u'wanglibao_pay_bank', 'bao_bind_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Card.bao_bind_id'
        db.add_column(u'wanglibao_pay_card', 'bao_bind_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bank.bao_bind_code'
        db.delete_column(u'wanglibao_pay_bank', 'bao_bind_code')

        # Deleting field 'Card.bao_bind_id'
        db.delete_column(u'wanglibao_pay_card', 'bao_bind_id')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'QnlS3E-kTBu_MUq1e9gkwg'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ZdiN_TrKTtSOWLhFcchE4A'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
