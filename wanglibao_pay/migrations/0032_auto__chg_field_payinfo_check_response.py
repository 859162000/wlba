...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'wanglibao_pay_payinfo', 'check_response', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'PayInfo.check_response'
        db.alter_column(u'wanglibao_pay_payinfo', 'check_response', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fEjEsGUaQBaQfeO7x1gXwQ'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'BxFeKMRwSFqaltIFCUJPvQ'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
