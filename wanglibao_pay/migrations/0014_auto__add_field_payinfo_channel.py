...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.channel'
        db.add_column(u'wanglibao_pay_payinfo', 'channel',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayInfo.channel'
        db.delete_column(u'wanglibao_pay_payinfo', 'channel')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6Lb4NmhKQgePqNUEMcq7Jw'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
