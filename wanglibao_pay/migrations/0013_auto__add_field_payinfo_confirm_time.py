...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.confirm_time'
        db.add_column(u'wanglibao_pay_payinfo', 'confirm_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayInfo.confirm_time'
        db.delete_column(u'wanglibao_pay_payinfo', 'confirm_time')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Z8yhcBVcQHW4W390rK2v_w'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
