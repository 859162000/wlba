...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.phone_for_card'
        db.add_column(u'wanglibao_pay_payinfo', 'phone_for_card',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Bank.pc_channel'
        db.add_column(u'wanglibao_pay_bank', 'pc_channel',
                      self.gf('django.db.models.fields.CharField')(default='huifu', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayInfo.phone_for_card'
        db.delete_column(u'wanglibao_pay_payinfo', 'phone_for_card')

        # Deleting field 'Bank.pc_channel'
        db.delete_column(u'wanglibao_pay_bank', 'pc_channel')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'PlmfuQhfRuKBN1BT3ER8ig'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'Kje_sYQrRRii71LKWEKAsw'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
