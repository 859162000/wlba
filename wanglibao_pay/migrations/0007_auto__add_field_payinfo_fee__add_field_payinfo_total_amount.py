...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.fee'
        db.add_column(u'wanglibao_pay_payinfo', 'fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'PayInfo.total_amount'
        db.add_column(u'wanglibao_pay_payinfo', 'total_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PayInfo.fee'
        db.delete_column(u'wanglibao_pay_payinfo', 'fee')

        # Deleting field 'PayInfo.total_amount'
        db.delete_column(u'wanglibao_pay_payinfo', 'total_amount')
