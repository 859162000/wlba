...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.management_amount'
        db.add_column(u'wanglibao_pay_payinfo', 'management_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Bank.withdraw_limit'
        db.add_column(u'wanglibao_pay_bank', 'withdraw_limit',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'WithdrawCardRecord.fee'
        db.add_column(u'wanglibao_pay_withdrawcardrecord', 'fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'WithdrawCardRecord.management_fee'
        db.add_column(u'wanglibao_pay_withdrawcardrecord', 'management_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'WithdrawCardRecord.management_amount'
        db.add_column(u'wanglibao_pay_withdrawcardrecord', 'management_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding index on 'WithdrawCardRecord', fields ['create_time']
        db.create_index(u'wanglibao_pay_withdrawcardrecord', ['create_time'])


    def backwards(self, orm):
        # Removing index on 'WithdrawCardRecord', fields ['create_time']
        db.delete_index(u'wanglibao_pay_withdrawcardrecord', ['create_time'])

        # Deleting field 'PayInfo.management_amount'
        db.delete_column(u'wanglibao_pay_payinfo', 'management_amount')

        # Deleting field 'Bank.withdraw_limit'
        db.delete_column(u'wanglibao_pay_bank', 'withdraw_limit')

        # Deleting field 'WithdrawCardRecord.fee'
        db.delete_column(u'wanglibao_pay_withdrawcardrecord', 'fee')

        # Deleting field 'WithdrawCardRecord.management_fee'
        db.delete_column(u'wanglibao_pay_withdrawcardrecord', 'management_fee')

        # Deleting field 'WithdrawCardRecord.management_amount'
        db.delete_column(u'wanglibao_pay_withdrawcardrecord', 'management_amount')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'xvaVf3N_TnSBJ34KJVL7zA'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ZvCsXvQXQXaKgHg358pgwA'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
