...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Card.last_update'
        db.add_column(u'wanglibao_pay_card', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Card.last_update'
        db.delete_column(u'wanglibao_pay_card', 'last_update')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'XTLfhT01QtireJsNyotTbg'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        }
    }
