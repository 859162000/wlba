...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PayInfo.is_checked'
        db.add_column(u'wanglibao_pay_payinfo', 'is_checked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'PayInfo.check_response'
        db.add_column(u'wanglibao_pay_payinfo', 'check_response',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding index on 'PayInfo', fields ['create_time']
        db.create_index(u'wanglibao_pay_payinfo', ['create_time'])


    def backwards(self, orm):
        # Removing index on 'PayInfo', fields ['create_time']
        db.delete_index(u'wanglibao_pay_payinfo', ['create_time'])

        # Deleting field 'PayInfo.is_checked'
        db.delete_column(u'wanglibao_pay_payinfo', 'is_checked')

        # Deleting field 'PayInfo.check_response'
        db.delete_column(u'wanglibao_pay_payinfo', 'check_response')
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'channel': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'check_response': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bAEuhWrNTJmRb0zFqlb2mA'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'_6-C5S2KRIWcmzBNwGiwUQ'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
