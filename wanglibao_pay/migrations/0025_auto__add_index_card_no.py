...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Card', fields ['no']
        db.create_index(u'wanglibao_pay_card', ['no'])


    def backwards(self, orm):
        # Removing index on 'Card', fields ['no']
        db.delete_index(u'wanglibao_pay_card', ['no'])
    ...
    models = {
        ...
        u'wanglibao_pay.payinfo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3c4XRXdIQBmvhmmV-IAqZA'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'})
        },
        ...
        u'wanglibao_pay.withdrawcardrecord': {
            ...
            'update_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'on_delete': 'models.PROTECT'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5jf_lStcR2WP4arHNRFxig'", 'unique': 'True', 'max_length': '32', 'db_index': 'True'}),
