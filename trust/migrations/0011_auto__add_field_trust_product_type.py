...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trust.product_type'
        db.add_column(u'trust_trust', 'product_type',
                      self.gf('django.db.models.fields.CharField')(default=u'\u4fe1\u6258', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trust.product_type'
        db.delete_column(u'trust_trust', 'product_type')
