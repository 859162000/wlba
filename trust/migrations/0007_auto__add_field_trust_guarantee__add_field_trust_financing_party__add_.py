...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trust.guarantee'
        db.add_column(u'trust_trust', 'guarantee',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Trust.financing_party'
        db.add_column(u'trust_trust', 'financing_party',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Trust.source_of_repayment'
        db.add_column(u'trust_trust', 'source_of_repayment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trust.guarantee'
        db.delete_column(u'trust_trust', 'guarantee')

        # Deleting field 'Trust.financing_party'
        db.delete_column(u'trust_trust', 'financing_party')

        # Deleting field 'Trust.source_of_repayment'
        db.delete_column(u'trust_trust', 'source_of_repayment')
