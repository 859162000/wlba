...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trust.status'
        db.add_column(u'trust_trust', 'status',
                      self.gf('django.db.models.fields.CharField')(default=u'\u5728\u552e', max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trust.status'
        db.delete_column(u'trust_trust', 'status')
