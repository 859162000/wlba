...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trust.bought_count_random'
        db.add_column(u'trust_trust', 'bought_count_random',
                      self.gf('django.db.models.fields.FloatField')(default=1.02),
                      keep_default=False)

        # Adding field 'Trust.bought_amount_random'
        db.add_column(u'trust_trust', 'bought_amount_random',
                      self.gf('django.db.models.fields.FloatField')(default=0.92),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trust.bought_count_random'
        db.delete_column(u'trust_trust', 'bought_count_random')

        # Deleting field 'Trust.bought_amount_random'
        db.delete_column(u'trust_trust', 'bought_amount_random')
    ...
    models = {
        ...
        u'trust.trust': {
            ...
            'bought_amount_random': ('django.db.models.fields.FloatField', [], {'default': '0.92'}),
            'bought_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'bought_count_random': ('django.db.models.fields.FloatField', [], {'default': '1.02'}),
