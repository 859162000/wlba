...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trust.expected_earning_rate_high'
        db.add_column(u'trust_trust', 'expected_earning_rate_high',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trust.expected_earning_rate_high'
        db.delete_column(u'trust_trust', 'expected_earning_rate_high')
